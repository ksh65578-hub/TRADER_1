...
class PatchResultRuntimeSchemaValidationTest(unittest.TestCase):
    ...
    def test_completed_route_chain_does_not_route_back_to_completed_rechecks(self):
        ...
        completed_route_task_classes = set(COMPLETED_ROUTE_TASK_CLASSES)
        ...
        if state["last_patch_id"].startswith("MVP4_STALE_LOOP_RECONCILIATION_AFTER_REGENERATION_REQUIRED_RECHECK_"):
            completed_route_task_classes.remove("MVP4_STALE_LOOP_RECONCILIATION_OPERATOR_QUEUE_PENDING_RECHECK")
        elif STALE_LOOP_REGENERATION_EXECUTION_REQUIRED_IMPLEMENTATION_DEPTH_RECHECK_REQUIREMENT_ID in completed:
            completed_route_task_classes.remove("MVP4_STALE_LOOP_RECONCILIATION_AFTER_REGENERATION_REQUIRED_RECHECK")
