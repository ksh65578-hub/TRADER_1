...
class ResidualOperatorEvidenceRunPreflightTest(unittest.TestCase):
    ...
    def test_preflight_binds_operator_run_command_without_running_it(self):
        ...
        self.assertEqual(report["command_id"], "UPBIT_PAPER_ADAPTIVE_EVIDENCE_REVIEW")
        ...
        self.assertIn("TRADER1_ROOT_OPERATOR_HEARTBEAT_TICKS=''", report["command_text"])
        self.assertEqual(report["minimum_duration_hours"], 0)
        self.assertEqual(report["minimum_paper_shadow_window_count"], 0)
        self.assertEqual(report["expected_heartbeat_ticks"], 0)
