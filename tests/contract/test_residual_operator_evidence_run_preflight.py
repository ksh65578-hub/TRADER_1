...
class ResidualOperatorEvidenceRunPreflightTest(unittest.TestCase):
    ...
    def test_preflight_binds_operator_run_command_without_running_it(self):
        ...
        self.assertEqual(report["command_id"], "UPBIT_PAPER_SAFE_MONITOR_48H")
        ...
        self.assertEqual(report["minimum_duration_hours"], 48)
        self.assertEqual(report["minimum_paper_shadow_window_count"], 8)
        self.assertEqual(report["expected_heartbeat_ticks"], 17280)
