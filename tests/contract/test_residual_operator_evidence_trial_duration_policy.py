...
class ResidualOperatorEvidenceTrialDurationPolicyTest(unittest.TestCase):
    ...
    def test_trial_profile_lowers_operator_run_without_creating_mvp5_evidence(self):
        ...
        self.assertEqual(report["formal_mvp5_profile_id"], "UPBIT_PAPER_ADAPTIVE_EVIDENCE_REVIEW")
        self.assertEqual(report["formal_mvp5_duration_hours"], 0)
        self.assertEqual(report["formal_mvp5_expected_heartbeat_ticks"], 0)
        self.assertEqual(report["formal_mvp5_minimum_paper_shadow_window_count"], 0)
