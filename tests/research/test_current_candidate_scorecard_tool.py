...
class CurrentCandidateScorecardToolTest(unittest.TestCase):
    ...
    def test_short_runtime_writes_blocked_scorecard_and_overfit_diagnostic(self):
        ...
        self.assertEqual(result["scorecard_candidate_identity_alignment_status"], "BOUND_TO_RUNTIME_SAMPLE")
        self.assertEqual(result["scorecard_runtime_sample_candidate_id"], scorecard["candidate_id"])
        self.assertIn(result["scorecard_runtime_sample_candidate_decision"], {"PAPER_ENTRY_REVIEW", "NO_TRADE"})
