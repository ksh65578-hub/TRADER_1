...
PATCH_BASENAME = "MVP4_DASHBOARD_LONG_RUN_DISPLAY_HISTORY_UX"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-DASHBOARD-LONG-RUN-DISPLAY-HISTORY-UX"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_dashboard_long_run_display_history_ux_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_DASHBOARD_LONG_RUN_DISPLAY_HISTORY_UX.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    base.write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_DASHBOARD_LONG_RUN_DISPLAY_HISTORY_UX.md",
        f"""# MVP4_DASHBOARD_LONG_RUN_DISPLAY_HISTORY_UX
...
The dashboard now separates normal current operation, display-history stability, and actual long-run PAPER/SHADOW evidence. Display history can look healthy without implying LIVE readiness or actual 24h runtime proof.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Dashboard display history is not actual long-run evidence",
            "full_text_marker": f"{REQUIREMENT_ID}: dashboard must distinguish display-history stability from actual long-run PAPER/SHADOW runtime evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Dashboard display-history long-run UX distinction",
            ...
            "source_text_sha256": base.sha256_bytes(
                b"dashboard must distinguish display-history stability from actual long-run PAPER/SHADOW runtime evidence"
            ),
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    base.write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "stage_gate_status": "PASS_DASHBOARD_DISPLAY_HISTORY_UX_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    base.write_text(
        ...
        f"""# MVP4 Dashboard Display-History UX Audit
    ...
    patch_result.update(
        {
            ...
            "optimizer_guardrail_result": "PASS_DISPLAY_HISTORY_NOT_OPTIMIZER_OR_LIVE_EVIDENCE",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_DISPLAY_HISTORY_SEPARATED_FROM_ACTUAL_RUNTIME",
            "convergence_guardrail_result": "PASS_DISPLAY_HISTORY_NOT_CONVERGENCE_OR_LIVE_EVIDENCE",
        }
    )
