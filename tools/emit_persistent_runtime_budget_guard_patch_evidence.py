...
PATCH_BASENAME = "MVP4_PERSISTENT_RUNTIME_BUDGET_GUARD"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-PERSISTENT-RUNTIME-BUDGET-GUARD"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_persistent_runtime_budget_guard_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_PERSISTENT_RUNTIME_BUDGET_GUARD.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    base.write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_PERSISTENT_RUNTIME_BUDGET_GUARD.md",
        f"""# MVP4_PERSISTENT_RUNTIME_BUDGET_GUARD
...
Actual long-run runtime evidence remains blocked. The persistent SHADOW runtime stub now rejects reports whose estimated runtime exceeds their own max runtime budget, and dashboard projection shows that drift as an error instead of a normal stub.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Persistent runtime budget guard",
            "full_text_marker": f"{REQUIREMENT_ID}: persistent runtime estimated duration cannot exceed max runtime budget",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Persistent runtime budget guard",
            "requirement_kind": "RUNTIME_SAFETY_PATCH",
            "schema_ids": ["trader1.shadow_observation_persistent_runtime_report.v1", "trader1.read_only_dashboard_shell.v1"],
            ...
            "live_affecting": True,
            "read_when": ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            "depends_on": [
                "REQ-MVP4-PERSISTENT-RUNTIME-RESOURCE-BOUNDARY",
                "REQ-MVP4-DASHBOARD-RUNTIME-EVIDENCE-BOUNDARY",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": base.sha256_bytes(b"persistent runtime estimated duration cannot exceed max runtime budget"),
...
def finalize_patch_result(patch_result: dict[str, Any], now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    patch_result.update(
        {
            "patch_id": PATCH_ID,
            "created_at_utc": now,
            ...
            "next_required_section_ids": ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            ...
            "active_read_surface_used": [
                ...
                "persistent shadow runtime validator",
                "dashboard persistent runtime projection",
                "runtime evidence boundary",
            ],
            "task_class": NEXT_TASK_CLASS,
            "required_section_ids": ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            "requirement_index_status": "UPDATED",
            "requirement_artifact_matrix_status": "UPDATED_PASS",
            "read_cache_manifest_status": "UPDATED",
            "context_pack_status": "UPDATED",
            "current_implementation_state_status": "UPDATED",
            "optimizer_guardrail_result": "PASS_PERSISTENT_RUNTIME_BUDGET_DRIFT_BLOCKED",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_PERSISTENT_RUNTIME_BUDGET_GUARD_ENFORCED",
            "convergence_guardrail_result": "PASS_PERSISTENT_RUNTIME_BUDGET_DRIFT_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    base.write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "stage_gate_status": "PASS_PERSISTENT_RUNTIME_BUDGET_GUARD_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    base.write_text(
        ...
        f"""# MVP4 Persistent Runtime Budget Guard Audit
...
def main() -> int:
    ...
    tests_run = [
        ...
        base.run_command([sys.executable, "-m", "unittest", "tests.research.test_shadow_observation_persistent_runtime", "-v"]),
