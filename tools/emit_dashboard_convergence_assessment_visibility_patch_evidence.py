...
PATCH_BASENAME = "MVP4_DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY"
REQUIREMENT_ID = "REQ-MVP4-DASHBOARD-CONVERGENCE-ASSESSMENT-VISIBILITY"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_dashboard_convergence_assessment_visibility_patch_evidence.py",
    ...
    "system/evidence/audit_reports/MVP4_DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY_20260429.md",
    "contracts/generated/context_pack/DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY.md",
]
...
def update_registry(now: str) -> None:
    ...
    for group in ("VALIDATOR_GROUP:MVP0_CORE", "VALIDATOR_GROUP:LIVE_SAFETY_CORE", "VALIDATOR_GROUP:CONVERGENCE_CORE", "supplemental_mvp4"):
        members = validators.setdefault(group, [])
        for validator_id in ("read_only_dashboard_validator", "convergence_assessment_validator"):
...
def update_navigation(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    ensure_requirement(
        index,
        {
            ...
            "source_section_id": "SECTION_DASHBOARD_CONVERGENCE_ASSESSMENT",
            "source_file": "TRADER_1.md",
            "source_heading": "dashboard convergence assessment visibility without live permission",
            "full_text_marker": f"{REQUIREMENT_ID}:dashboard shows convergence assessment dependency closure model drift writer input blocked scale up blocked",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Dashboard convergence assessment visibility",
            "requirement_kind": "DASHBOARD_UX_PATCH",
            "schema_ids": ["trader1.read_only_dashboard_shell.v1"],
            "validator_ids": ["read_only_dashboard_validator", "convergence_assessment_validator"],
            ...
            "depends_on": [
                "REQ-MVP4-CONVERGENCE-ASSESSMENT-SCHEMA-HARDENING",
                "REQ-MVP4-DASHBOARD-PROFITABILITY-MATURITY-UX-HARDENING",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(
                b"dashboard shows convergence assessment dependency closure model drift writer input blocked scale up blocked"
            ),
    ...
    ensure_matrix_row(
        ...
        {
            "requirement_id": REQUIREMENT_ID,
            "section_id": "SECTION_DASHBOARD_CONVERGENCE_ASSESSMENT",
    ...
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY.md",
        f"""# DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY

context_pack_id: DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY
task_class: MVP4_DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY
source_trader1_sha256: {trader_hash}
source_agents_sha256: {agents_hash}
included_section_ids: ["SECTION_DASHBOARD_OPERATOR_UX", "SECTION_CONVERGENCE_ASSESSMENT", "SECTION_OPTIMIZER_CONVERGENCE_GUARDRAIL", "SECTION_LIVE_FINAL_GUARD"]
...
- Dashboard shows Convergence Assessment with dependency closure and model drift status.
- Writer input, model promotion, live orders, and scale-up remain false.
- Normal convergence review uses blue/green; collecting uses yellow; forbidden input uses red.
...
Read-only dashboards show system status, operator next action, workflow, portfolio, positions, strategy evidence maturity, execution feedback, risk exposure, and convergence assessment. Convergence assessment is explicitly display-only and cannot create writer input, live readiness, live order permission, or scale-up permission.
""",
    )
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(
        ROOT / "system" / "evidence" / "patch_results" / "MVP4_CONVERGENCE_ASSESSMENT_SCHEMA_HARDENING.patch_result.json"
    )
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_EXPLORATION_EXPLOITATION_POLICY_SCHEMA_RECHECK",
            "next_required_section_ids": [
                "SECTION_EXPLORATION_EXPLOITATION_POLICY",
                "SECTION_OPTIMIZER_CONVERGENCE_GUARDRAIL",
                "SECTION_LIVE_FINAL_GUARD",
            ],
            "next_optional_section_ids": ["SECTION_DASHBOARD_OPERATOR_UX", "SECTION_MODEL_DRIFT"],
            ...
            "optimizer_patch": "DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY_ANALYSIS_ONLY",
            "optimizer_stage": "MVP4_REVIEW_PREP",
            "optimizer_status_before": "CONVERGENCE_ASSESSMENT_STRICT_SCHEMA_LIVE_BLOCKED",
            "optimizer_status_after": "CONVERGENCE_ASSESSMENT_VISIBLE_LIVE_BLOCKED",
            "optimizer_maturity_level_before": "MVP4_CONVERGENCE_ASSESSMENT_SCHEMA_HARDENED",
            "optimizer_maturity_level_after": "MVP4_CONVERGENCE_ASSESSMENT_OPERATOR_VISIBLE",
            "optimizer_output_type": "DASHBOARD_DISPLAY_ONLY_CONVERGENCE_STATUS",
            ...
            "optimizer_validators_run": [
                ...
                in {"read_only_dashboard_validator", "convergence_assessment_validator", "optimizer_guardrail_validator"}
            ],
            ...
            "profit_convergence_patch": "DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY_NO_LIVE_MUTATION",
            "convergence_layer_changed": False,
            "convergence_state_before": "CONVERGENCE_ASSESSMENT_SCHEMA_HARDENED_LIVE_BLOCKED",
            "convergence_state_after": "CONVERGENCE_ASSESSMENT_DASHBOARD_VISIBLE_LIVE_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_DASHBOARD_CONVERGENCE_ASSESSMENT_VISIBILITY_LIVE_REVIEW_STILL_BLOCKED",
            "next_allowed_task_class": "MVP4_EXPLORATION_EXPLOITATION_POLICY_SCHEMA_RECHECK",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Convergence Assessment Visibility
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_EXPLORATION_EXPLOITATION_POLICY_SCHEMA_RECHECK"
    ...
    state["implemented_validator_ids"] = sorted(
        set(state.get("implemented_validator_ids", []) + ["read_only_dashboard_validator", "convergence_assessment_validator"])
    )
