...
PATCH_BASENAME = "MVP4_PAPER_SHADOW_RUNTIME_SOURCE_REQUIRED_FIELDS"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-PAPER-SHADOW-RUNTIME-SOURCE-REQUIRED-FIELDS"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_paper_shadow_runtime_source_required_fields_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_PAPER_SHADOW_RUNTIME_SOURCE_REQUIRED_FIELDS.md",
]
...
def write_context(now: str, trader_hash: str, agents_hash: str) -> None:
    base.write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_PAPER_SHADOW_RUNTIME_SOURCE_REQUIRED_FIELDS.md",
        f"""# MVP4_PAPER_SHADOW_RUNTIME_SOURCE_REQUIRED_FIELDS
...
PAPER/SHADOW evidence now rejects legacy partial reports that omit explicit actual-runtime and supporting-source fields.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Paper/shadow evidence actual runtime source field closure",
            "full_text_marker": f"{REQUIREMENT_ID}: actual runtime and supporting source fields are mandatory for paper/shadow evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Paper/shadow runtime source required fields",
            ...
            "depends_on": [
                "REQ-MVP4-PAPER-SHADOW-ACTUAL-RUNTIME-SOURCE-IDENTITY-HYGIENE",
                "REQ-MVP4-PAPER-SHADOW-LONG-RUN-STATE-CONSISTENCY",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": base.sha256_bytes(b"paper shadow runtime source required fields"),
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_PAPER_SHADOW_LONG_RUN_STATE_CONSISTENCY.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "active_read_surface_used": [
                ...
                "legacy partial runtime source field probe",
            ],
            "task_class": NEXT_TASK_CLASS,
            ...
            "optimizer_status_after": "PAPER_SCORECARD_INPUT_ONLY_RUNTIME_SOURCE_FIELDS_REQUIRED",
            "optimizer_guardrail_result": "PASS_LEGACY_PARTIAL_RUNTIME_SOURCE_REPORT_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_RUNTIME_SOURCE_FIELDS_REQUIRED",
            "convergence_guardrail_result": "PASS_LEGACY_PARTIAL_RUNTIME_SOURCE_REPORT_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    base.write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_RUNTIME_SOURCE_REQUIRED_FIELDS_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    base.write_text(
        ...
        f"""# MVP4 Paper/Shadow Runtime Source Required Fields Audit
