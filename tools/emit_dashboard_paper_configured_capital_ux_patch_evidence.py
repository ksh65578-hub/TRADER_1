...
PATCH_BASENAME = "MVP4_DASHBOARD_PAPER_CONFIGURED_CAPITAL_UX"
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "DASHBOARD_PAPER_CONFIGURED_CAPITAL_UX.md",
        f"""# DASHBOARD_PAPER_CONFIGURED_CAPITAL_UX
...
The read-only dashboard now separates configured PAPER starting capital from verified portfolio truth. UPBIT KRW_SPOT PAPER shows 1,000,000 KRW as configured PAPER capital when the current PAPER ledger snapshot is missing or stale, while Cash, Equity, PnL, and positions remain UNVERIFIED until a fresh simulated ledger source is loaded.
""",
    )
    ...
    patch_result.update(
        {
            ...
            "retained_archive_semantic_mapping_status": "UNCHANGED_NOT_REQUIRED_FOR_CONFIGURED_CAPITAL_UX",
            "read_cache_update_required": True,
            "context_pack_update_required": True,
            "current_implementation_state_updated": True,
            "next_task_class": "MVP4_UPBIT_PAPER_PORTFOLIO_LEDGER_REFRESH",
            "next_required_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_MVP1_SUMMARY_SHELL", "SECTION_MVP1_LEDGER", "SECTION_LIVE_FINAL_GUARD"],
            "next_optional_section_ids": ["SECTION_MVP1_RECONCILIATION", "SECTION_MVP4_RUNTIME_EVIDENCE"],
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_CONFIGURED_CAPITAL_UX",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_DASHBOARD_PAPER_CONFIGURED_CAPITAL_UX_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_json(
        ROOT / patch_result["evidence_manifest_path"],
        {
            ...
            "artifact_paths": [
                ...
                "tools/emit_dashboard_paper_configured_capital_ux_patch_evidence.py",
                "contracts/generated/context_pack/DASHBOARD_PAPER_CONFIGURED_CAPITAL_UX.md",
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard PAPER Configured Capital UX Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_UPBIT_PAPER_PORTFOLIO_LEDGER_REFRESH"
...
def main() -> int:
    ...
    tests_run = [
        run_command([sys.executable, "-m", "pytest", "-q", "tests/dashboard/test_summary_writer.py", "tests/dashboard/test_read_only_dashboard.py"]),
