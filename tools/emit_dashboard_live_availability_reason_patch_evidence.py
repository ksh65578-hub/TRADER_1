...
PATCH_BASENAME = "MVP4_DASHBOARD_LIVE_AVAILABILITY_REASON"
PATCH_ID = f"{PATCH_BASENAME}_20260505_001"
REQUIREMENT_ID = "REQ-MVP4-DASHBOARD-LIVE-AVAILABILITY-REASON"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_dashboard_live_availability_reason_patch_evidence.py",
...
included_requirement_ids: ["{REQUIREMENT_ID}", "REQ-MVP4-DASHBOARD-OPERATOR-FOCUS-SIMPLIFICATION", "REQ-MVP4-LIVE-FINAL-GUARD"]
...
Dashboard first view now answers live execution availability as a direct No/Blocked decision and keeps the raw blocker plus all live/scale false flags visible for audit.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Dashboard live availability answer",
            "full_text_marker": (
                f"{REQUIREMENT_ID}: dashboard must answer live availability as a direct no/blocked decision "
                "while preserving raw blocker traceability and false live/scale flags"
            ),
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Dashboard explains live availability directly",
            ...
            "depends_on": [
                "REQ-MVP4-DASHBOARD-OPERATOR-FOCUS-SIMPLIFICATION",
                "REQ-MVP1-READ-ONLY-DASHBOARD-SHELL",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": base.sha256_bytes(
                b"dashboard direct live availability no blocked decision with raw blocker traceability"
            ),
    ...
    patch_result.update(
        {
            ...
            "optimizer_guardrail_result": "PASS_DASHBOARD_LIVE_AVAILABILITY_EXPLAINED_LIVE_BLOCKED",
            "convergence_guardrail_result": "PASS_DASHBOARD_LIVE_AVAILABILITY_EXPLAINED_LIVE_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "stage_gate_status": "PASS_DASHBOARD_LIVE_AVAILABILITY_EXPLAINED_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Live Availability Reason Audit
