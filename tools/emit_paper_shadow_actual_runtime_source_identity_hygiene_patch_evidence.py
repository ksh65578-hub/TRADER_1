...
PATCH_BASENAME = "MVP4_PAPER_SHADOW_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-PAPER-SHADOW-ACTUAL-RUNTIME-SOURCE-IDENTITY-HYGIENE"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_paper_shadow_actual_runtime_source_identity_hygiene_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_PAPER_SHADOW_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    base.write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_PAPER_SHADOW_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE.md",
        f"""# MVP4_PAPER_SHADOW_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE

context_pack_id: MVP4_PAPER_SHADOW_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE
...
- Long-run PAPER/SHADOW evidence cannot use dashboard, summary, heartbeat, launcher, startup_probe, or stability_history ids as actual runtime source evidence.
- VALIDATED_NON_LIVE_RUNTIME requires at least two actual runtime source ids.
- Actual runtime source ids must be scoped to the same exchange, market_type, PAPER/SHADOW sessions, and 64-hex source hashes.
- Actual runtime source ids must include both PAPER and SHADOW persistent runtime sources.
...
- ACTUAL_PERSISTENT_RUNTIME_EXECUTION_MISSING remains open until validated non-live long-run runtime artifacts exist
...
Long-run PAPER/SHADOW evidence remains blocked. Actual runtime source identity is now scoped and display-truth artifacts cannot be reused as execution evidence.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Paper/shadow actual runtime source identity hygiene",
            "full_text_marker": f"{REQUIREMENT_ID}: actual runtime source ids must be non-live PAPER and SHADOW runtime evidence, not dashboard display truth",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Paper/shadow actual runtime source identity hygiene",
            ...
            "source_text_sha256": base.sha256_bytes(
                b"actual runtime source ids must be scoped non-live PAPER and SHADOW runtime evidence"
            ),
    ...
    patch_result.update(
        {
            ...
            "active_read_surface_used": [
                ...
                "actual runtime source boundary patches",
            ],
            "task_class": NEXT_TASK_CLASS,
            ...
            "optimizer_status_after": "PAPER_SCORECARD_INPUT_ONLY_LONG_RUN_SOURCE_IDENTITY_GUARDED",
            "optimizer_guardrail_result": "PASS_DISPLAY_TRUTH_NOT_ACCEPTED_AS_ACTUAL_RUNTIME_SOURCE",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_ACTUAL_RUNTIME_SOURCE_IDENTITY_GUARDED",
            "convergence_guardrail_result": "PASS_DISPLAY_TRUTH_NOT_ACCEPTED_AS_ACTUAL_RUNTIME_SOURCE",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    base.write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_ACTUAL_RUNTIME_SOURCE_IDENTITY_HYGIENE_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    base.write_text(
        ...
        f"""# MVP4 Paper/Shadow Actual Runtime Source Identity Hygiene Audit
