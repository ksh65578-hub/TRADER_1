...
PATCH_BASENAME = "MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD"
PATCH_ID = f"{PATCH_BASENAME}_20260502_001"
REQUIREMENT_ID = "REQ-MVP4-UPBIT-PAPER-POST-RERUN-BLOCKER-ROLLUP-SOURCE-BINDING-GUARD"
NEXT_TASK_CLASS = "MVP4_UPBIT_PAPER_POST_RERUN_OPERATOR_RECONCILIATION_REVIEW_GUIDANCE_SOURCE_BINDING_GUARD"

if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))

import tools.emit_persistent_runtime_resource_boundary_patch_evidence as base  # noqa: E402
import tools.emit_upbit_paper_post_rerun_reconciliation_blocker_rollup_patch_evidence as previous  # noqa: E402
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_upbit_paper_post_rerun_blocker_rollup_source_binding_guard_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD.md",
]
...
def write_context(now: str, trader_hash: str, agents_hash: str, report: dict[str, Any]) -> None:
    base.write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD.md",
        f"""# MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD

context_pack_id: MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD
task_class: MVP4_UPBIT_PAPER_POST_RERUN_BLOCKER_ROLLUP_SOURCE_BINDING_GUARD
...
- The blocker rollup reloads the source decision audit artifact from disk.
- The source artifact's stored decision_audit_hash and recomputed hash must match the in-memory source decision audit hash.
- Missing, invalid, scope-mismatched, or hash-mismatched source decision audit files block the rollup.
...
- source_file_load_status: {report["source_decision_audit_file_load_status"]}
- source_file_hash_match: {str(report["source_decision_audit_file_hash_match"]).lower()}
...
Upbit PAPER post-rerun reconciliation blocker rollup evidence is now bound to the persisted decision audit artifact hash. Missing or mismatched source files block the rollup while all live and scale-up flags remain false.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Upbit PAPER post-rerun blocker rollup source binding guard",
            "full_text_marker": (
                f"{REQUIREMENT_ID}: post-rerun reconciliation blocker rollup must bind source decision audit "
                "evidence to the persisted source artifact hash before unresolved blocker counts are accepted"
            ),
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Upbit PAPER post-rerun blocker rollup source binding guard",
            ...
            "depends_on": [
                ...
                "REQ-MVP4-UPBIT-PAPER-POST-RERUN-DECISION-AUDIT-SOURCE-BINDING-GUARD",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": base.sha256_bytes(b"post rerun blocker rollup source decision audit file hash binding"),
    ...
    rows.append(
        {
            ...
            "patch_result_fields": [
                ...
                "post_rerun_blocker_rollup_source_decision_audit_file_load_status",
                "post_rerun_blocker_rollup_source_decision_audit_file_hash_match",
    ...
    patch_result.update(
        {
            ...
            "active_read_surface_used": [
                ...
                "persisted decision audit artifact",
                "live final guard",
            ],
            ...
            "post_rerun_blocker_rollup_source_decision_audit_file_load_status": report["source_decision_audit_file_load_status"],
            "post_rerun_blocker_rollup_source_decision_audit_file_hash_match": report["source_decision_audit_file_hash_match"],
            "optimizer_guardrail_result": "PASS_BLOCKER_ROLLUP_SOURCE_DECISION_AUDIT_ARTIFACT_HASH_BOUND",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any], report: dict[str, Any]) -> None:
    ...
    base.write_text(
        ...
        f"""# MVP4 Upbit PAPER Post-Rerun Blocker Rollup Source Binding Guard Audit
...
- blocker_rollup_status: {report["blocker_rollup_status"]}
- source_file_load_status: {report["source_decision_audit_file_load_status"]}
- source_file_hash_match: {report["source_decision_audit_file_hash_match"]}
- current_evidence_write_allowed_count: {report["current_evidence_write_allowed_count"]}
