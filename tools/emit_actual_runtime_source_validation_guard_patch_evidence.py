...
PATCH_BASENAME = "MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-ACTUAL-RUNTIME-SOURCE-VALIDATION-GUARD"
...
CHANGED_ARTIFACTS = [
    "trader1/research/shadow/shadow_observation_actual_runtime_blocker.py",
    "contracts/schema/shadow_observation_actual_runtime_blocker_report.schema.json",
    "tests/research/test_shadow_observation_actual_runtime_blocker.py",
    "tools/emit_actual_runtime_source_validation_guard_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD.md",
        f"""# MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD

context_pack_id: MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD
...
included_schema_ids: ["trader1.shadow_observation_actual_runtime_blocker_report.v1"]
included_validator_ids: {json.dumps(VALIDATORS_REQUIRED)}
included_artifact_ids: {json.dumps(CHANGED_ARTIFACTS)}
source_section_hashes: see contracts/generated/authority_section_map.json

acceptance_checklist:
- Actual runtime blocker standalone validation rejects source hash verification drift.
- Actual runtime blocker standalone validation rejects non-PASS source runtime status.
- Exact source-runtime context still preserves the more precise source blocker code.
...
Actual long-run PAPER/SHADOW evidence remains missing. The actual runtime blocker now rejects standalone source hash or source validation status drift, so a detached report cannot be display-trusted as valid source-bound evidence.
    ...
    requirements.append(
        {
            ...
            "full_text_marker": f"{REQUIREMENT_ID}: actual runtime blocker report cannot be display-trusted when detached source hash or source validation status drifts",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Actual runtime source validation guard",
            "requirement_kind": "RUNTIME_SAFETY_PATCH",
            "schema_ids": ["trader1.shadow_observation_actual_runtime_blocker_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/research/test_shadow_observation_actual_runtime_blocker.py"],
            "mvp_stage": "MVP-4",
            ...
            "source_text_sha256": sha256_bytes(
                b"actual runtime blocker standalone validation rejects detached source hash or source validation status drift"
            ),
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/shadow_observation_actual_runtime_blocker_report.schema.json"],
            "validator_files": ["trader1/research/shadow/shadow_observation_actual_runtime_blocker.py"],
            "test_files": ["tests/research/test_shadow_observation_actual_runtime_blocker.py"],
            "fixture_files": [],
            "runtime_modules": ["trader1/research/shadow/shadow_observation_actual_runtime_blocker.py"],
            "evidence_artifacts": [
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_LONG_RUN_EVIDENCE_THRESHOLD_FLOOR.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.shadow_observation_actual_runtime_blocker_report.v1"],
            ...
            "active_read_surface_used": [
                ...
                "shadow actual runtime blocker",
                "actual runtime blocker schema",
            ...
            "optimizer_stage": "NOT_CHANGED_SOURCE_VALIDATION_GUARD_ONLY",
            ...
            "optimizer_guardrail_result": "PASS_ACTUAL_RUNTIME_SOURCE_VALIDATION_DRIFT_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_before": "LONG_RUN_EVIDENCE_BLOCKED",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_SOURCE_VALIDATION_DRIFT_GUARDED",
            "convergence_guardrail_result": "PASS_ACTUAL_RUNTIME_SOURCE_VALIDATION_DRIFT_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Actual Runtime Source Validation Guard Audit
