...
PATCH_BASENAME = "MVP4_UI_COMPLETION_RECHECK_OPERATOR_FLOW_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-UI-COMPLETION-RECHECK-OPERATOR-FLOW-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_ui_completion_recheck_operator_flow_hardening_patch_evidence.py",
    "contracts/generated/context_pack/UI_COMPLETION_RECHECK_OPERATOR_FLOW.md",
    "system/evidence/audit_reports/MVP4_UI_COMPLETION_RECHECK_OPERATOR_FLOW_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "UI_COMPLETION_RECHECK_OPERATOR_FLOW.md",
        f"""# UI_COMPLETION_RECHECK_OPERATOR_FLOW
...
Dashboard now shows a four-step Operator Workflow: Run PAPER, Inspect Dashboard, Collect Evidence, and LIVE Review Blocked. The workflow is display-only, validated against the current operator action, and cannot create order or scale-up permission.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Operator workflow completion recheck",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_DASHBOARD_SHELL:Operator flow visible and live-blocked",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Show operator workflow and block live review until evidence exists",
            ...
            "depends_on": [
                ...
                "REQ-MVP4-OPERATOR-ACTION-SUMMARY-HARDENING",
            ],
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_UI_COMPLETION_RECHECK_AND_OPERATOR_FLOW_HARDENING",
            ...
            "active_read_surface_used": ["SECTION_DASHBOARD_SHELL", "SECTION_OPERATOR_VISIBILITY", "SECTION_LIVE_FINAL_GUARD"],
            "task_class": "MVP4_UI_COMPLETION_RECHECK_AND_OPERATOR_FLOW_HARDENING",
            "required_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_OPERATOR_VISIBILITY", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": [
                "TRADER_1:dashboard-shell-active-surface",
                "TRADER_1:operator-visibility-active-surface",
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_OPERATOR_WORKFLOW_SUMMARY",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_OPERATOR_WORKFLOW_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 UI Completion Recheck Operator Flow Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_UI_COMPLETION_RECHECK_AND_OPERATOR_FLOW_HARDENING"
