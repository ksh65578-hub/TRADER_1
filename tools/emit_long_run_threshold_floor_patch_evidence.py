...
PATCH_BASENAME = "MVP4_LONG_RUN_EVIDENCE_THRESHOLD_FLOOR"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-LONG-RUN-EVIDENCE-THRESHOLD-FLOOR"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_long_run_threshold_floor_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_LONG_RUN_EVIDENCE_THRESHOLD_FLOOR.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_LONG_RUN_EVIDENCE_THRESHOLD_FLOOR.md",
        f"""# MVP4_LONG_RUN_EVIDENCE_THRESHOLD_FLOOR
...
Actual long-run PAPER/SHADOW evidence remains missing. Runtime blocker and orchestration reports now reject weakened long-run threshold floors, so short-window or stub evidence cannot be reframed as long-run proof by lowering required duration, cycle, or evidence-window counts.
    ...
    requirements.append(
        {
            ...
            "full_text_marker": f"{REQUIREMENT_ID}: long-run runtime evidence thresholds cannot be weakened to convert short-window evidence into review evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Long-run runtime evidence threshold floor",
            "requirement_kind": "RUNTIME_SAFETY_PATCH",
            "schema_ids": [
                "trader1.shadow_observation_actual_runtime_blocker_report.v1",
                "trader1.shadow_observation_runtime_orchestration_report.v1",
            ],
            ...
            "source_text_sha256": sha256_bytes(
                b"long-run runtime evidence thresholds cannot be weakened to convert short-window evidence into review evidence"
            ),
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_DASHBOARD_STABILITY_SCALEUP_LOCK.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "active_read_surface_used": [
                ...
                "long-run evidence threshold floor schemas",
            ],
            ...
            "optimizer_stage": "NOT_CHANGED_LONG_RUN_THRESHOLD_FLOOR_ONLY",
            ...
            "optimizer_guardrail_result": "PASS_LONG_RUN_THRESHOLD_WEAKENING_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_before": "LONG_RUN_EVIDENCE_BLOCKED",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_THRESHOLD_FLOORS_ENFORCED",
            "convergence_guardrail_result": "PASS_LONG_RUN_THRESHOLD_WEAKENING_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_LONG_RUN_THRESHOLD_FLOORS_ENFORCED_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Long-Run Evidence Threshold Floor Audit
