...
PATCH_BASENAME = "MVP4_STRATEGY_PERFORMANCE_MEMORY_SCHEMA_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-STRATEGY-PERFORMANCE-MEMORY-SCHEMA-HARDENING"
...
FIXTURE_FILES = [
    "tests/validators/fixtures/strategy_performance_memory_pass.json",
    "tests/validators/fixtures/strategy_performance_memory_live_flag_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_raw_pnl_positive_net_negative_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_insufficient_sample_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_missing_reason_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_downtrend_trade_allowed_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_live_source_mixing_fail.json",
    "tests/validators/fixtures/strategy_performance_memory_unscoped_fail.json",
]
...
CHANGED_ARTIFACTS = [
    ...
    "tests/validators/test_strategy_performance_memory_validator.py",
    *FIXTURE_FILES,
    "tools/run_strategy_performance_memory_validators.py",
    "tools/emit_strategy_performance_memory_schema_hardening_patch_evidence.py",
    "contracts/generated/context_pack/STRATEGY_PERFORMANCE_MEMORY_SCHEMA.md",
    "system/evidence/audit_reports/MVP4_STRATEGY_PERFORMANCE_MEMORY_SCHEMA_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "STRATEGY_PERFORMANCE_MEMORY_SCHEMA.md",
        f"""# STRATEGY_PERFORMANCE_MEMORY_SCHEMA
...
Strategy performance memory now requires net EV after cost, paper/shadow source separation, explicit entry/exit/no-trade reasons, regime coverage, downtrend and risk-off no-trade enforcement, and false fields for live readiness, live orders, exchange account calls, live config mutation, ACTIVE snapshot mutation, and scale-up.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Strategy performance memory schema",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_CONVERGENCE_MEMORY:Strategy performance memory must preserve net EV and regime evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Harden strategy performance memory against raw PnL, source mixing, and regime blindness",
            "requirement_kind": "OPTIMIZER_CONVERGENCE_GUARDRAIL",
            "schema_ids": ["trader1.strategy_performance_memory.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/validators/test_strategy_performance_memory_validator.py"],
            "mvp_stage": "MVP-4",
            ...
            "depends_on": [
                "REQ-MVP4-OPTIMIZER-MEMORY-STATE-SCHEMA-HARDENING",
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/strategy_performance_memory.schema.json"],
            "validator_files": ["trader1/validation/mvp0_validators.py"],
            "test_files": ["tests/validators/test_strategy_performance_memory_validator.py"],
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.strategy_performance_memory.v1"],
            ...
            "next_task_class": "MVP4_MARKET_REGIME_ADAPTATION_SCHEMA_RECHECK",
            "next_required_section_ids": ["SECTION_CONVERGENCE_MEMORY", "SECTION_MARKET_REGIME_ADAPTATION", "SECTION_LIVE_FINAL_GUARD"],
            "next_optional_section_ids": ["SECTION_SYMBOL_REGIME_FIT", "SECTION_DASHBOARD_SHELL"],
            ...
            "active_read_surface_used": ["SECTION_CONVERGENCE_MEMORY", "SECTION_STRATEGY_PERFORMANCE_MEMORY", "SECTION_LIVE_FINAL_GUARD"],
            "task_class": "MVP4_STRATEGY_PERFORMANCE_MEMORY_SCHEMA_HARDENING",
            "required_section_ids": ["SECTION_CONVERGENCE_MEMORY", "SECTION_STRATEGY_PERFORMANCE_MEMORY", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": [
                "TRADER_1:strategy-performance-memory-active-surface",
                "TRADER_1:net-ev-after-cost-requirement",
                "AGENTS:strategy-performance-negative-fixtures",
            ],
            ...
            "optimizer_patch": "STRATEGY_PERFORMANCE_MEMORY_SCHEMA_HARDENING",
            "optimizer_stage": "MVP4_ANALYSIS_ONLY",
            "optimizer_status_before": "STRATEGY_PERFORMANCE_MEMORY_SCHEMA_SCAFFOLD_ONLY",
            "optimizer_status_after": "STRICT_NET_EV_REGIME_MEMORY_VALIDATED",
            "optimizer_maturity_level_before": "MVP4_SCAFFOLD",
            "optimizer_maturity_level_after": "MVP4_NEGATIVE_FIXTURE_VALIDATED",
            "optimizer_output_type": "STRATEGY_PERFORMANCE_MEMORY_ONLY",
            "optimizer_guardrail_result": "PASS_NO_LIVE_PERMISSION",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "STRATEGY_PERFORMANCE_NET_EV_MEMORY_HARDENING",
            "convergence_layer_changed": True,
            "convergence_state_before": "STRATEGY_PERFORMANCE_MEMORY_SCHEMA_SCAFFOLD_ONLY",
            "convergence_state_after": "NET_EV_REGIME_PERFORMANCE_MEMORY_VALIDATED_NO_LIVE_PERMISSION",
            "objective_profile_changed": False,
            "memory_schema_changed": True,
            "failure_analysis_required": True,
            "failure_analysis_status": "REQUIRED_FOR_NEGATIVE_NET_EV_AND_REGIME_FAILURES",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_STRATEGY_PERFORMANCE_MEMORY_SCHEMA_HARDENING_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Strategy Performance Memory Schema Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(set(state.get("implemented_schema_ids", []) + ["trader1.strategy_performance_memory.v1"]))
    state["implemented_validator_ids"] = sorted(set(state.get("implemented_validator_ids", []) + ["strategy_performance_memory_validator"]))
    state["untested_validator_ids"] = [item for item in state.get("untested_validator_ids", []) if item != "strategy_performance_memory_validator"]
    state["last_patch_id"] = PATCH_ID
    state["last_patch_result_hash"] = patch_result["result_hash"]
    state["next_allowed_task_class"] = "MVP4_MARKET_REGIME_ADAPTATION_SCHEMA_RECHECK"
...
def main() -> int:
    ...
    tests_run = [
        ...
        run_command([sys.executable, "-m", "unittest", "tests.validators.test_convergence_foundation_validators", "-v"]),
        run_command([sys.executable, "-m", "unittest", "tests.validators.test_optimizer_memory_state_validator", "-v"]),
        ...
        run_command([sys.executable, "tools/run_optimizer_memory_state_validators.py"]),
