...
PATCH_BASENAME = "MVP4_RISK_EXPOSURE_FALSE_SAFE_RECHECK"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-RISK-EXPOSURE-FALSE-SAFE-RECHECK"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_risk_exposure_false_safe_recheck_patch_evidence.py",
    "contracts/generated/context_pack/RISK_EXPOSURE_FALSE_SAFE_RECHECK.md",
    "system/evidence/audit_reports/MVP4_RISK_EXPOSURE_FALSE_SAFE_RECHECK_20260429.md",
...
def patch_hash(patch_result: dict[str, Any]) -> str:
    body = {key: value for key, value in patch_result.items() if key != "result_hash"}
    return sha256_json(body)


def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "RISK_EXPOSURE_FALSE_SAFE_RECHECK.md",
        f"""# RISK_EXPOSURE_FALSE_SAFE_RECHECK
...
PAPER risk exposure now separates notional data quality from drawdown data quality. Missing drawdown hard truth is ATTENTION, not LOW_RISK. The dashboard still cannot approve live trading or scale-up.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Risk exposure false-safe hardening",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_RISK_SIZING_EXPOSURE:missing drawdown cannot appear low risk",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Missing drawdown hard truth cannot appear LOW_RISK",
            ...
            "live_affecting": True,
            "read_when": ["SECTION_RISK_SIZING_EXPOSURE", "SECTION_DASHBOARD_OPERATOR_UX", "SECTION_LIVE_FINAL_GUARD"],
            "depends_on": [
                "REQ-MVP4-RISK-EXPOSURE-DRAWDOWN-UX-HARDENING",
                "REQ-MVP4-SCALEUP-SAFETY-BLOCKED",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(b"missing drawdown cannot appear low risk"),
    ...
    patch_result.update(
        {
            ...
            "merged_requirements": [],
            "new_registry_items": [
                f"contracts/generated/context_pack/RISK_EXPOSURE_FALSE_SAFE_RECHECK.md",
                REQUIREMENT_ID,
            ],
            ...
            "optimizer_patch": "NO_OPTIMIZER_RUNTIME_CHANGE_RISK_EXPOSURE_FALSE_SAFE_RECHECK",
            "optimizer_status_before": "RISK_EXPOSURE_DISPLAY_WITH_DRAWNDOWN_DEFAULT_RISK",
            "optimizer_status_after": "RISK_EXPOSURE_DISPLAY_WITH_DRAWNDOWN_HARD_TRUTH_GATE",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_RISK_EXPOSURE_FALSE_SAFE_RECHECK_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Risk Exposure False-Safe Recheck Audit
