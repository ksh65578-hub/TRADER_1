...
PATCH_BASENAME = "MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-ACTUAL-RUNTIME-HARNESS-THRESHOLD-FLOOR"
...
CHANGED_ARTIFACTS = [
    ...
    "contracts/schema/shadow_observation_actual_runtime_harness_report.schema.json",
    "tests/research/test_shadow_observation_actual_runtime_harness.py",
    "tools/emit_actual_runtime_harness_threshold_floor_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR.md",
        f"""# MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR

context_pack_id: MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR
...
- Short-window actual runtime harness reports reject weakened long-run runtime floors below 86400 seconds.
- Short-window actual runtime harness reports reject weakened long-run cycle floors below 2880 cycles.
- Short-window harness output remains non-live operational evidence only, not long-run, scorecard, promotion, LIVE_READY, or scale-up evidence.
...
Actual long-run PAPER/SHADOW evidence remains missing. Short-window actual runtime harness reports now enforce the same long-run threshold floors as blocker and orchestration reports, so lowered runtime or cycle requirements cannot make harness output look like long-run evidence.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Actual long-run PAPER/SHADOW evidence boundary",
            "full_text_marker": f"{REQUIREMENT_ID}: actual runtime harness long-run threshold floors cannot be weakened to convert short-window evidence into long-run evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Actual runtime harness threshold floor",
            "requirement_kind": "RUNTIME_SAFETY_PATCH",
            "schema_ids": ["trader1.shadow_observation_actual_runtime_harness_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/research/test_shadow_observation_actual_runtime_harness.py"],
            "mvp_stage": "MVP-4",
            ...
            "depends_on": [
                ...
                "REQ-MVP4-ACTUAL-RUNTIME-SOURCE-VALIDATION-GUARD",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(
                b"actual runtime harness threshold floors cannot be weakened to convert short-window evidence into long-run evidence"
            ),
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/shadow_observation_actual_runtime_harness_report.schema.json"],
            "validator_files": ["trader1/research/shadow/shadow_observation_actual_runtime_harness.py"],
            "test_files": ["tests/research/test_shadow_observation_actual_runtime_harness.py"],
            "fixture_files": [],
            "runtime_modules": ["trader1/research/shadow/shadow_observation_actual_runtime_harness.py"],
            "evidence_artifacts": [
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_ACTUAL_RUNTIME_SOURCE_VALIDATION_GUARD.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.shadow_observation_actual_runtime_harness_report.v1"],
            ...
            "active_read_surface_used": [
                ...
                "shadow actual runtime harness",
                "actual runtime harness schema",
                "long-run evidence boundary tests",
            ],
            "task_class": NEXT_TASK_CLASS,
            ...
            "optimizer_stage": "NOT_CHANGED_HARNESS_THRESHOLD_FLOOR_ONLY",
            ...
            "optimizer_guardrail_result": "PASS_ACTUAL_RUNTIME_HARNESS_THRESHOLD_WEAKENING_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_before": "LONG_RUN_EVIDENCE_BLOCKED_SOURCE_VALIDATION_DRIFT_GUARDED",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_HARNESS_THRESHOLD_FLOORS_ENFORCED",
            "convergence_guardrail_result": "PASS_ACTUAL_RUNTIME_HARNESS_THRESHOLD_WEAKENING_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOORS_ENFORCED_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Actual Runtime Harness Threshold Floor Audit
    ...
    tests_run = [
        ...
        run_command(
            [
                ...
                "tests.research.test_shadow_observation_actual_runtime_blocker",
