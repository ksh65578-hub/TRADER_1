...
PATCH_BASENAME = "MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-OPTIMIZER-RECOMMENDATION-LIVE-SEPARATION-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tests/validators/test_optimizer_recommendation_validator.py",
    "tests/validators/fixtures/optimizer_recommendation_pass.json",
    "tests/validators/fixtures/optimizer_recommendation_live_flag_fail.json",
    "tests/validators/fixtures/optimizer_recommendation_live_ready_wording_fail.json",
    "tests/validators/fixtures/optimizer_recommendation_scope_mismatch_fail.json",
    "tests/validators/fixtures/optimizer_recommendation_live_writer_fail.json",
    "tools/run_optimizer_recommendation_validators.py",
    "tools/emit_optimizer_recommendation_live_separation_hardening_patch_evidence.py",
    "contracts/generated/context_pack/OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION.md",
    "system/evidence/audit_reports/MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION.md",
        f"""# OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION

context_pack_id: OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION
task_class: MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_HARDENING
...
included_schema_ids: ["trader1.optimizer_recommendation_report.v1"]
included_validator_ids: {json.dumps(VALIDATORS_REQUIRED)}
included_artifact_ids: {json.dumps(CHANGED_ARTIFACTS)}
source_section_hashes: see contracts/generated/authority_section_map.json

acceptance_checklist:
- optimizer recommendation artifact is structurally marked as PAPER ranking recommendation only
- ALLOW_PAPER_RANKING cannot imply LIVE_READY, write live snapshots, mutate live config, or scale up
- misleading LIVE_READY wording in optimizer recommendation warnings is rejected
...
- optimizer recommendations remain analysis/ranking input only and cannot approve live readiness
...
## Current Safe State
        ...
        Optimizer recommendation reports now carry PAPER-only scope, NOT_LIVE_READY status, and explicit no-live/no-scale fields. ALLOW_PAPER_RANKING remains non-live evidence only.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Optimizer recommendation live separation",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_OPTIMIZER_GUARDRAIL:Optimizer recommendation cannot be presented as LIVE_READY",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Separate optimizer recommendation output from LIVE_READY and scale-up eligibility",
            "requirement_kind": "OPTIMIZER_GUARDRAIL",
            "schema_ids": ["trader1.optimizer_recommendation_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/validators/test_optimizer_recommendation_validator.py"],
            "mvp_stage": "MVP-4",
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/optimizer_recommendation_report.schema.json"],
            "validator_files": ["trader1/validation/mvp0_validators.py"],
            "test_files": ["tests/validators/test_optimizer_recommendation_validator.py"],
            "fixture_files": [],
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.optimizer_recommendation_report.v1"],
            ...
            "next_task_class": "MVP4_OPTIMIZER_RUN_GUARDRAIL_SCHEMA_RECHECK",
            ...
            "active_read_surface_used": ["SECTION_STRATEGY_EVIDENCE", "SECTION_OPTIMIZER_GUARDRAIL", "SECTION_CONVERGENCE_GUARDRAIL", "SECTION_LIVE_FINAL_GUARD"],
            "task_class": "MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_HARDENING",
            "required_section_ids": ["SECTION_STRATEGY_EVIDENCE", "SECTION_OPTIMIZER_GUARDRAIL", "SECTION_CONVERGENCE_GUARDRAIL", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": [
                "TRADER_1:optimizer-guardrail-active-surface",
                "TRADER_1:convergence-guardrail-active-surface",
                "AGENTS:optimizer-recommendation-validator",
            ],
            ...
            "optimizer_patch": "OPTIMIZER_RECOMMENDATION_OUTPUT_GUARD_HARDENING",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "OPTIMIZER_RECOMMENDATION_SCOPE_GUARD_HARDENING",
            "convergence_layer_changed": False,
            "failure_analysis_required": False,
            "failure_analysis_status": "NOT_REQUIRED_FOR_OPTIMIZER_RECOMMENDATION_SCOPE_GUARD",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Optimizer Recommendation Live Separation Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(set(state.get("implemented_schema_ids", []) + ["trader1.optimizer_recommendation_report.v1"]))
    state["implemented_validator_ids"] = sorted(set(state.get("implemented_validator_ids", []) + ["optimizer_recommendation_validator"]))
    state["last_patch_id"] = PATCH_ID
    state["last_patch_result_hash"] = patch_result["result_hash"]
    state["next_allowed_task_class"] = "MVP4_OPTIMIZER_RUN_GUARDRAIL_SCHEMA_RECHECK"
