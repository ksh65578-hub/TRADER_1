...
PATCH_BASENAME = "MVP4_LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-LEDGER-RECONCILIATION-IDEMPOTENCY-RECHECK"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_ledger_reconciliation_idempotency_recheck_patch_evidence.py",
    "contracts/generated/context_pack/LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK.md",
    "system/evidence/audit_reports/MVP4_LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK.md",
        f"""# LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK
...
Ledger and intent WAL validation now reject duplicate semantic writes that could otherwise pass with fresh IDs. Restart recovery remains PAPER-only and live-blocked.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Ledger, reconciliation, idempotency, and restart recovery",
            "full_text_marker": f"{REQUIREMENT_ID}:duplicate writer and semantic idempotency must fail closed",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Duplicate ledger/WAL writer recheck",
            "requirement_kind": "RUNTIME_SAFETY_VALIDATOR_PATCH",
            "schema_ids": [
                "trader1.ledger_event.v1",
                "trader1.intent_wal_event.v1",
                "trader1.restart_recovery_report.v1",
                "trader1.reconciliation_report.v1",
            ],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/runtime/test_execution_ledger.py", "tests/runtime/test_restart_recovery.py", "tests/runtime/test_reconciliation.py"],
            "mvp_stage": "MVP-4",
            ...
            "depends_on": [
                "REQ-MVP1-EXECUTION-LEDGER",
                "REQ-MVP1-RECONCILIATION",
                "REQ-MVP2-RESTART-RECOVERY",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(b"duplicate writer and semantic idempotency must fail closed"),
    ...
    rows.append(
        {
            ...
            "test_files": ["tests/runtime/test_execution_ledger.py", "tests/runtime/test_restart_recovery.py", "tests/runtime/test_reconciliation.py"],
            "fixture_files": [],
            "runtime_modules": [
                "trader1/runtime/ledger/execution_ledger.py",
                "trader1/core/events/intent_wal.py",
...
def build_patch_result(
    ...
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_RISK_EXPOSURE_FALSE_SAFE_RECHECK.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "merged_requirements": [],
            "new_registry_items": [
                f"contracts/generated/context_pack/LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK.md",
                REQUIREMENT_ID,
            ],
            ...
            "next_optional_section_ids": ["SECTION_DASHBOARD_OPERATOR_UX", "SECTION_RUNTIME_WRITE_LOCK"],
            ...
            "optimizer_patch": "NO_OPTIMIZER_RUNTIME_CHANGE_LEDGER_IDEMPOTENCY_RECHECK",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_LEDGER_IDEMPOTENCY_RECHECK_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Ledger Reconciliation Idempotency Recheck Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(
        set(state.get("implemented_schema_ids", []) + ["trader1.intent_wal_event.v1", "trader1.restart_recovery_report.v1"])
    )
    state["implemented_validator_ids"] = sorted(
        set(state.get("implemented_validator_ids", []) + ["ledger_durability_validator", "restart_recovery_validator", "reconciliation_validator", "ledger_reconciliation_validator"])
    )
...
def main() -> int:
    ...
    tests_run = [
        ...
        run_command([sys.executable, "-m", "json.tool", "contracts/schema/restart_recovery_report.schema.json"]),
        run_command([sys.executable, "-m", "unittest", "tests.runtime.test_execution_ledger", "tests.runtime.test_restart_recovery", "tests.runtime.test_reconciliation", "-v"]),
        run_command([sys.executable, "UPBIT_PAPER.py"]),
        run_command([sys.executable, "BINANCE_PAPER.py"]),
    ]
    validators_run = run_validators(BOOTSTRAP_VALIDATORS_REQUIRED)
    patch_result = build_patch_result(now, tests_run, validators_run, BOOTSTRAP_VALIDATORS_REQUIRED)
    patch_path = ROOT / "system" / "evidence" / "patch_results" / f"{PATCH_BASENAME}.patch_result.json"
