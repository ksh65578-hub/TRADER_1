...
PATCH_BASENAME = "MVP4_CANDIDATE_SCORECARD_LIVE_SEPARATION_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-CANDIDATE-SCORECARD-LIVE-SEPARATION-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_candidate_scorecard_live_separation_hardening_patch_evidence.py",
    "contracts/generated/context_pack/CANDIDATE_SCORECARD_LIVE_SEPARATION.md",
    "system/evidence/audit_reports/MVP4_CANDIDATE_SCORECARD_LIVE_SEPARATION_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "CANDIDATE_SCORECARD_LIVE_SEPARATION.md",
        f"""# CANDIDATE_SCORECARD_LIVE_SEPARATION
...
## Current Safe State
        ...
        Candidate scorecards now carry PAPER-only scope, NOT_LIVE_READY status, and an explicit operator warning. Optimizer and convergence layers can rank scorecard inputs only as non-live evidence.
""",
    )
...
def update_requirement_artifacts(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    requirements.append(
        {
            ...
            "source_section_id": "SECTION_STRATEGY_EVIDENCE",
            "source_file": "TRADER_1.md",
            "source_heading": "Candidate scorecard live separation",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_STRATEGY_EVIDENCE:Candidate scorecard ranking input cannot be presented as LIVE_READY",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Separate candidate scorecard ranking input from LIVE_READY and scale-up eligibility",
    ...
    rows.append(
        {
            "requirement_id": REQUIREMENT_ID,
            "section_id": "SECTION_STRATEGY_EVIDENCE",
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_RECHECK",
            ...
            "expanded_section_ids": [
                ...
                "AGENTS:candidate-scorecard-net-ev-validator",
            ],
            ...
            "optimizer_patch": "CANDIDATE_SCORECARD_INPUT_GUARD_HARDENING",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "SCORECARD_INPUT_SCOPE_GUARD_HARDENING",
            "convergence_layer_changed": False,
            "failure_analysis_required": False,
            "failure_analysis_status": "NOT_REQUIRED_FOR_CANDIDATE_SCORECARD_SCOPE_GUARD",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_CANDIDATE_SCORECARD_LIVE_SEPARATION_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Candidate Scorecard Live Separation Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(set(state.get("implemented_schema_ids", []) + ["trader1.candidate_scorecard.v1"]))
    state["implemented_validator_ids"] = sorted(set(state.get("implemented_validator_ids", []) + ["candidate_scorecard_net_ev_validator"]))
    state["last_patch_id"] = PATCH_ID
    state["last_patch_result_hash"] = patch_result["result_hash"]
    state["next_allowed_task_class"] = "MVP4_OPTIMIZER_RECOMMENDATION_LIVE_SEPARATION_RECHECK"
