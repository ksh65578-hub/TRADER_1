...
PATCH_BASENAME = "MVP4_RESIDUAL_OPERATOR_RECONCILIATION_INTAKE_PREFLIGHT"
...
REVIEW_CARDS_REPORT_PATH = "system/evidence/audit_reports/MVP4_RESIDUAL_OPERATOR_RECONCILIATION_REVIEW_CARDS.report.json"
EVIDENCE_INTAKE_REPORT_PATH = "system/evidence/audit_reports/MVP4_RESIDUAL_OPERATOR_EVIDENCE_INTAKE_AUDIT.report.json"
...
from trader1.reports.residual_operator_reconciliation_intake_preflight import (  # noqa: E402
    SCHEMA_ID,
...
CHANGED_ARTIFACTS = [
    "trader1/reports/residual_operator_reconciliation_intake_preflight.py",
    "contracts/schema/residual_operator_reconciliation_intake_preflight_report.schema.json",
    "contracts/schema/read_only_dashboard_shell.schema.json",
    "contracts/registry.yaml",
    "trader1/dashboard/read_only_dashboard.py",
    "tests/contract/test_residual_operator_reconciliation_intake_preflight.py",
    "tests/dashboard/test_read_only_dashboard.py",
    "tools/emit_residual_operator_reconciliation_intake_preflight_patch_evidence.py",
    f"contracts/generated/context_pack/{PATCH_BASENAME}.md",
] + ROUTE_GUARD_TEST_ARTIFACTS
SOURCE_EVIDENCE_ARTIFACTS = [REVIEW_CARDS_REPORT_PATH, EVIDENCE_INTAKE_REPORT_PATH]
EVIDENCE_ARTIFACTS = [
...
def load_sources() -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    return (
        base.load_json(ROOT / REVIEW_CARDS_REPORT_PATH),
        base.load_json(ROOT / EVIDENCE_INTAKE_REPORT_PATH),
...
def build_report(
    ...
    review_cards_report, evidence_intake_report, current_state = load_sources()
    state = state_before or current_state
    report = build_residual_operator_reconciliation_intake_preflight_report(
        review_cards_report,
    ...
    if errors:
        raise RuntimeError("residual operator reconciliation intake preflight failed: " + "; ".join(errors))
...
task_class: MVP4_RESIDUAL_OPERATOR_RECONCILIATION_INTAKE_PREFLIGHT
...
included_requirement_ids: ["{REQUIREMENT_ID}", "REQ-MVP4-RESIDUAL-OPERATOR-RECONCILIATION-REVIEW-CARDS", "REQ-MVP4-RESIDUAL-OPERATOR-EVIDENCE-INTAKE-AUDIT", "REQ-MVP4-LIVE-FINAL-GUARD"]
...
- Convert blocked review cards into reconciliation intake preflight requirements.
- Keep all {report["required_intake_item_count"]} reconciliation evidence inputs missing and unaccepted.
- Keep all {report["control_requirement_count"]} controls unsatisfied.
...
- required_intake_item_count: {report["required_intake_item_count"]}
- missing_intake_item_count: {report["missing_intake_item_count"]}
- ready_for_review_intake_item_count: {report["ready_for_review_intake_item_count"]}
- accepted_intake_item_count: {report["accepted_intake_item_count"]}
- operator_reconciliation_submission_manifest_status: {report["operator_reconciliation_submission_manifest_status"]}
- selected_next_task_class: {report["selected_next_task_class"]}

known_omissions_by_design:
- This patch does not perform operator reconciliation.
- This patch does not accept, hash, or stage an operator submission package.
...
Operator reconciliation review cards now project into a blocked intake preflight. The operator submission manifest is not validated, {report["required_intake_item_count"]} required inputs remain missing, and current evidence writes remain blocked.
    ...
    requirements.append(
        {
            ...
            "source_heading": "residual operator reconciliation intake preflight",
            "full_text_marker": (
                f"{REQUIREMENT_ID}: blocked review cards must project to operator reconciliation intake "
                "requirements without accepting evidence, mutating current evidence, or enabling live/scale"
            ),
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Residual operator reconciliation intake preflight",
            ...
            "depends_on": [
                "REQ-MVP4-RESIDUAL-OPERATOR-RECONCILIATION-REVIEW-CARDS",
                "REQ-MVP4-RESIDUAL-OPERATOR-EVIDENCE-INTAKE-AUDIT",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": base.sha256_bytes(b"residual operator reconciliation intake preflight blocked"),
            "source_authority_sha256": trader_hash,
            "implementation_status": "IMPLEMENTED_RECONCILIATION_INTAKE_PREFLIGHT_BLOCKED",
            "test_status": "PASS",
        }
    )
    req_index.update(
    ...
    rows.append(
        {
            ...
            "live_affecting": True,
            "status": "IMPLEMENTED_RECONCILIATION_INTAKE_PREFLIGHT_BLOCKED",
        }
    )
    matrix.update(
        {
    ...
    patch_result.update(
        {
            ...
            "new_registry_items": [REQUIREMENT_ID, "residual_operator_reconciliation_intake_preflight_report"],
            ...
            "active_read_surface_used": [
                ...
                "residual operator reconciliation review cards report",
            ...
            "current_implementation_state_status": "UPDATED_RECONCILIATION_INTAKE_PREFLIGHT_BLOCKED",
            "optimizer_stage": "NOT_CHANGED_RECONCILIATION_INTAKE_PREFLIGHT_ONLY",
            "optimizer_guardrail_result": "PASS_RECONCILIATION_INTAKE_PREFLIGHT_NO_LIVE_MUTATION_NO_SCALE_UP",
            "convergence_guardrail_result": "PASS_RECONCILIATION_INTAKE_PREFLIGHT_NO_LIVE_PERMISSION_NO_SCALE_UP",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any], report: dict[str, Any]) -> None:
    ...
    base.assert_false_flags("reconciliation intake preflight report", report, "")
    ...
    base.write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "stage_gate_status": "PASS_RECONCILIATION_INTAKE_PREFLIGHT_BLOCKED",
            "open_gap_count": report["open_gap_count"],
            "required_intake_item_count": report["required_intake_item_count"],
            "missing_intake_item_count": report["missing_intake_item_count"],
            "ready_for_review_intake_item_count": report["ready_for_review_intake_item_count"],
            "accepted_intake_item_count": report["accepted_intake_item_count"],
            "control_requirement_count": report["control_requirement_count"],
            "operator_reconciliation_submission_manifest_status": report[
    ...
    base.write_text(
        ...
        f"""# MVP4 Residual Operator Reconciliation Intake Preflight
...
Patch:
- Added {report["required_intake_item_count"]} reconciliation intake requirements from the blocked review cards.
- Kept missing_intake_item_count={report["missing_intake_item_count"]}.
- Kept ready_for_review_intake_item_count={report["ready_for_review_intake_item_count"]}.
- Kept accepted_intake_item_count={report["accepted_intake_item_count"]}.
...
| --- | --- | --- |
| Reconciliation intake preflight | IMPLEMENTED_BLOCKED | {REPORT_PATH} |
| Source review cards | BOUND_BLOCKED | {REVIEW_CARDS_REPORT_PATH} |
| Intake inputs | MISSING | {report["missing_intake_item_count"]} missing of {report["required_intake_item_count"]} |
...
""",
    ...
    base.write_json(
        ...
        {
            "patch_id": PATCH_ID,
            "dashboard_status": "PASS_RECONCILIATION_INTAKE_PREFLIGHT_BLOCKED",
            "preflight_status": report["preflight_status"],
            "required_intake_item_count": report["required_intake_item_count"],
            "missing_intake_item_count": report["missing_intake_item_count"],
...
System status: non-live reconciliation review can continue; live and scale remain blocked.

What changed:
- Added a reconciliation intake preflight for {report["required_intake_item_count"]} required evidence inputs.
- All inputs remain missing/unaccepted.
- No user runtime is required for the next non-live Codex patch.

Still blocked:
- Gap closure needs a separate validated operator reconciliation submission package.
