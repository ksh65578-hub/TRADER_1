...
PATCH_BASENAME = "MVP4_OPTIMIZER_RUN_GUARDRAIL_SCHEMA_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-OPTIMIZER-RUN-GUARDRAIL-SCHEMA-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tests/validators/test_optimizer_run_report_validator.py",
    "tests/validators/fixtures/optimizer_run_pass.json",
    "tests/validators/fixtures/optimizer_run_live_flag_fail.json",
    "tests/validators/fixtures/optimizer_run_live_mode_fail.json",
    "tests/validators/fixtures/optimizer_run_live_ready_wording_fail.json",
    "tests/validators/fixtures/optimizer_run_missing_blocker_fail.json",
    "tests/validators/fixtures/optimizer_run_live_writer_fail.json",
    "tests/validators/fixtures/optimizer_run_raw_pnl_objective_fail.json",
    "tools/run_optimizer_run_guardrail_validators.py",
    "tools/run_optimizer_recommendation_validators.py",
    "tools/emit_optimizer_run_guardrail_schema_hardening_patch_evidence.py",
    "contracts/generated/context_pack/OPTIMIZER_RUN_GUARDRAIL_SCHEMA.md",
    "system/evidence/audit_reports/MVP4_OPTIMIZER_RUN_GUARDRAIL_SCHEMA_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "OPTIMIZER_RUN_GUARDRAIL_SCHEMA.md",
        f"""# OPTIMIZER_RUN_GUARDRAIL_SCHEMA
...
Optimizer run reports now require non-live source modes, NET_EV_AFTER_COST ranking basis, NOT_LIVE_READY wording, and explicit false fields for live orders, exchange-account calls, LIVE_READY writes, live config mutation, and scale-up.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Optimizer run guardrail schema",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_OPTIMIZER_GUARDRAIL:Optimizer run report cannot imply live readiness or scale-up",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Harden optimizer run output as non-live net-EV analysis artifact",
            "requirement_kind": "OPTIMIZER_GUARDRAIL",
            "schema_ids": ["trader1.optimizer_run_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/validators/test_optimizer_run_report_validator.py"],
            "mvp_stage": "MVP-4",
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/optimizer_run_report.schema.json"],
            "validator_files": ["trader1/validation/mvp0_validators.py"],
            "test_files": ["tests/validators/test_optimizer_run_report_validator.py"],
            "fixture_files": [
                "tests/validators/fixtures/optimizer_run_pass.json",
                "tests/validators/fixtures/optimizer_run_live_flag_fail.json",
                "tests/validators/fixtures/optimizer_run_live_mode_fail.json",
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.optimizer_run_report.v1"],
            ...
            "next_task_class": "MVP4_OPTIMIZER_GUARDRAIL_REPORT_SCHEMA_RECHECK",
            ...
            "expanded_section_ids": [
                ...
                "TRADER_1:profit-convergence-cost-basis",
            ...
            "optimizer_patch": "OPTIMIZER_RUN_REPORT_GUARDRAIL_SCHEMA_HARDENING",
            "optimizer_stage": "MVP4_ANALYSIS_ONLY",
            "optimizer_status_before": "SCAFFOLD_SCHEMA_NO_RUN_VALIDATOR",
            "optimizer_status_after": "STRICT_NON_LIVE_RUN_REPORT_VALIDATED",
            "optimizer_maturity_level_before": "MVP4_SCAFFOLD",
            "optimizer_maturity_level_after": "MVP4_NEGATIVE_FIXTURE_VALIDATED",
            "optimizer_output_type": "ANALYSIS_OR_PAPER_RANKING_INPUT_ONLY",
            "optimizer_guardrail_result": "PASS_NO_LIVE_PERMISSION",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "OPTIMIZER_RUN_COST_BASIS_AND_LIVE_SEPARATION_HARDENING",
            "convergence_layer_changed": False,
            "failure_analysis_required": False,
            "failure_analysis_status": "NOT_REQUIRED_FOR_OPTIMIZER_RUN_SCHEMA_GUARD",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_OPTIMIZER_RUN_GUARDRAIL_SCHEMA_HARDENING_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Optimizer Run Guardrail Schema Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(set(state.get("implemented_schema_ids", []) + ["trader1.optimizer_run_report.v1"]))
    state["implemented_validator_ids"] = sorted(set(state.get("implemented_validator_ids", []) + ["optimizer_run_report_validator"]))
    state["last_patch_id"] = PATCH_ID
    state["last_patch_result_hash"] = patch_result["result_hash"]
    state["next_allowed_task_class"] = "MVP4_OPTIMIZER_GUARDRAIL_REPORT_SCHEMA_RECHECK"
