...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "WINDOWS_CONSOLE_SAFE_MONITOR_DEFAULT.md",
        f"""# WINDOWS_CONSOLE_SAFE_MONITOR_DEFAULT
    ...
    patch_result.update(
        {
            ...
            "retained_archive_semantic_mapping_status": "UNCHANGED_NOT_REQUIRED_FOR_WINDOWS_CONSOLE_MONITOR_DEFAULT",
            "read_cache_update_required": True,
            "context_pack_update_required": True,
            "current_implementation_state_updated": True,
            "next_task_class": "MVP4_UPBIT_PAPER_PERSISTENT_RUNTIME_RECOVERY",
            "next_required_section_ids": ["SECTION_MVP1_ROOT_LAUNCHER_SCOPE", "SECTION_MVP1_HEARTBEAT", "SECTION_LIVE_FINAL_GUARD"],
            "next_optional_section_ids": ["SECTION_MVP4_RUNTIME_EVIDENCE", "SECTION_WINDOWS_LONG_RUN_RECOVERY"],
            ...
            "task_class": "MVP4_WINDOWS_CONSOLE_SAFE_MONITOR_DEFAULT",
            "required_section_ids": ["SECTION_MVP1_ROOT_LAUNCHER_SCOPE", "SECTION_MVP1_HEARTBEAT", "SECTION_LIVE_FINAL_GUARD"],
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_WINDOWS_CONSOLE_MONITOR_DEFAULT",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_WINDOWS_CONSOLE_SAFE_MONITOR_DEFAULT_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_json(
        ROOT / patch_result["evidence_manifest_path"],
        {
            ...
            "artifact_paths": [
                ...
                "contracts/generated/context_pack/WINDOWS_CONSOLE_SAFE_MONITOR_DEFAULT.md",
    ...
    write_text(
        ...
        f"""# MVP4 Windows Console Safe Monitor Default Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_UPBIT_PAPER_PERSISTENT_RUNTIME_RECOVERY"
