...
PATCH_BASENAME = "MVP4_OPTIMIZATION_STATE_SCHEMA_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-OPTIMIZATION-STATE-SCHEMA-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tests/validators/test_optimization_state_validator.py",
    "tests/validators/fixtures/optimization_state_pass.json",
    "tests/validators/fixtures/optimization_state_live_flag_fail.json",
    "tests/validators/fixtures/optimization_state_dependency_override_fail.json",
    "tests/validators/fixtures/optimization_state_live_ready_wording_fail.json",
    "tests/validators/fixtures/optimization_state_missing_blocker_fail.json",
    "tests/validators/fixtures/optimization_state_active_snapshot_mutation_fail.json",
    "tests/validators/fixtures/optimization_state_raw_pnl_objective_fail.json",
    "tools/run_optimization_state_validators.py",
    ...
    "tools/emit_optimization_state_schema_hardening_patch_evidence.py",
    "contracts/generated/context_pack/OPTIMIZATION_STATE_SCHEMA.md",
    "system/evidence/audit_reports/MVP4_OPTIMIZATION_STATE_SCHEMA_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "OPTIMIZATION_STATE_SCHEMA.md",
        f"""# OPTIMIZATION_STATE_SCHEMA
...
Optimization state now requires append-audit-only write policy, explicit dependency status, NOT_LIVE_READY wording, and false fields for ACTIVE snapshot mutation, optimizer/paper winner live config promotion, live orders, exchange account calls, live config mutation, and scale-up.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Optimization state schema",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_OPTIMIZER_GUARDRAIL:Optimization state cannot mutate live or active config",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Harden optimization state against live or ACTIVE config mutation",
            "requirement_kind": "OPTIMIZER_GUARDRAIL",
            "schema_ids": ["trader1.optimization_state.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/validators/test_optimization_state_validator.py"],
            "mvp_stage": "MVP-4",
            ...
            "depends_on": [
                "REQ-MVP4-OPTIMIZER-GUARDRAIL-REPORT-SCHEMA-HARDENING",
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/optimization_state.schema.json"],
            "validator_files": ["trader1/validation/mvp0_validators.py"],
            "test_files": ["tests/validators/test_optimization_state_validator.py"],
            "fixture_files": [
                "tests/validators/fixtures/optimization_state_pass.json",
                "tests/validators/fixtures/optimization_state_live_flag_fail.json",
                "tests/validators/fixtures/optimization_state_dependency_override_fail.json",
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.optimization_state.v1"],
            ...
            "next_task_class": "MVP4_OPTIMIZER_MEMORY_STATE_SCHEMA_RECHECK",
            ...
            "expanded_section_ids": [
                ...
                "TRADER_1:optimizer-active-config-mutation-ban",
                "AGENTS:optimizer-state-negative-fixtures",
            ],
            ...
            "optimizer_patch": "OPTIMIZATION_STATE_SCHEMA_HARDENING",
            "optimizer_stage": "MVP4_ANALYSIS_ONLY",
            "optimizer_status_before": "SCAFFOLD_SCHEMA_NO_STATE_VALIDATOR",
            "optimizer_status_after": "STRICT_NON_LIVE_OPTIMIZATION_STATE_VALIDATED",
            "optimizer_maturity_level_before": "MVP4_SCAFFOLD",
            "optimizer_maturity_level_after": "MVP4_NEGATIVE_FIXTURE_VALIDATED",
            "optimizer_output_type": "APPEND_AUDIT_STATE_ONLY",
            "optimizer_guardrail_result": "PASS_NO_LIVE_PERMISSION",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "OPTIMIZATION_STATE_NON_LIVE_WRITE_POLICY_HARDENING",
            "convergence_layer_changed": False,
            "failure_analysis_required": False,
            "failure_analysis_status": "NOT_REQUIRED_FOR_OPTIMIZATION_STATE_SCHEMA",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_OPTIMIZATION_STATE_SCHEMA_HARDENING_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Optimization State Schema Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(set(state.get("implemented_schema_ids", []) + ["trader1.optimization_state.v1"]))
    state["implemented_validator_ids"] = sorted(set(state.get("implemented_validator_ids", []) + ["optimization_state_validator"]))
    state["last_patch_id"] = PATCH_ID
    state["last_patch_result_hash"] = patch_result["result_hash"]
    state["next_allowed_task_class"] = "MVP4_OPTIMIZER_MEMORY_STATE_SCHEMA_RECHECK"
