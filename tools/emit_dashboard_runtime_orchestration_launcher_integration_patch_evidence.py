...
PATCH_BASENAME = "MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_LAUNCHER_INTEGRATION"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-DASHBOARD-RUNTIME-ORCHESTRATION-LAUNCHER-INTEGRATION"
...
from trader1.runtime.boot.safe_launcher import build_launcher_report, load_json as load_runtime_json, write_launcher_dashboard  # noqa: E402
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_dashboard_runtime_orchestration_launcher_integration_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_LAUNCHER_INTEGRATION.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_LAUNCHER_INTEGRATION.md",
        f"""# MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_LAUNCHER_INTEGRATION
...
The safe launcher now connects runtime orchestration display artifacts into the actual dashboard generation path. The visible dashboard remains display truth only and cannot create optimizer ranking, scorecard input, live readiness, live order permission, or scale-up.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Dashboard source artifact wiring",
            "full_text_marker": f"{REQUIREMENT_ID}: safe launcher must pass runtime orchestration display artifacts into the actual dashboard shell",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Safe launcher runtime orchestration dashboard integration",
            ...
            "source_text_sha256": sha256_bytes(
                b"safe launcher must pass runtime orchestration display artifacts into the actual dashboard shell"
            ),
    ...
    rows.append(
        {
            ...
            "fixture_files": [],
            "runtime_modules": ["trader1/runtime/boot/safe_launcher.py", "trader1/dashboard/read_only_dashboard.py"],
            "evidence_artifacts": [
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_registry_items": [REQUIREMENT_ID, "contracts/generated/context_pack/MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_LAUNCHER_INTEGRATION.md"],
            ...
            "active_read_surface_used": [
                ...
                "safe launcher dashboard artifact wiring",
                "dashboard shell runtime orchestration projection",
            ...
            "optimizer_stage": "NOT_CHANGED_DASHBOARD_WIRING_ONLY",
            ...
            "optimizer_validators_required": ["read_only_dashboard_validator", "shadow_observation_runtime_orchestration_validator", "live_final_guard_validator"],
            ...
            "optimizer_guardrail_result": "PASS_LAUNCHER_DASHBOARD_WIRING_BLOCKS_OPTIMIZER_RANKING",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "false",
            "convergence_layer_changed": False,
            "convergence_state_before": "DASHBOARD_RENDERER_ORCHESTRATION_VISIBLE_BUT_LAUNCHER_SOURCE_WIRING_MISSING",
            "convergence_state_after": "SAFE_LAUNCHER_LOADS_ORCHESTRATION_DISPLAY_ARTIFACTS_FAIL_CLOSED",
            ...
            "convergence_validators_required": ["read_only_dashboard_validator", "shadow_observation_runtime_orchestration_validator", "live_final_guard_validator"],
            "convergence_validators_run": [
                "read_only_dashboard_validator:PASS",
                "shadow_observation_runtime_orchestration_validator:PASS",
                "live_final_guard_validator:PASS",
            ],
            "convergence_guardrail_result": "PASS_LAUNCHER_WIRES_ORCHESTRATION_AS_DISPLAY_ONLY_LIVE_BLOCKED",
...
def regenerate_upbit_dashboard() -> dict[str, Any]:
    ...
    return {
        "command": "safe local UPBIT_PAPER dashboard regeneration without credentials",
        "status": "PASS"
        if shell.get("live_order_ready") is False
        ...
        "operation_status": shell.get("operation_status", {}).get("status"),
        "runtime_orchestration_status": shell.get("shadow_runtime_orchestration_status", {}).get("status"),
    }
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_LAUNCHER_DASHBOARD_ORCHESTRATION_WIRING_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Runtime Orchestration Launcher Integration Audit
