...
PATCH_BASENAME = "MVP4_STRATEGY_EVIDENCE_PROGRESS_UX_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-STRATEGY-EVIDENCE-PROGRESS-UX-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_strategy_evidence_progress_ux_hardening_patch_evidence.py",
    "contracts/generated/context_pack/STRATEGY_EVIDENCE_PROGRESS_UX.md",
    "system/evidence/audit_reports/MVP4_STRATEGY_EVIDENCE_PROGRESS_UX_HARDENING_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "STRATEGY_EVIDENCE_PROGRESS_UX.md",
        f"""# STRATEGY_EVIDENCE_PROGRESS_UX
...
## Current Safe State
        ...
        Dashboard strategy evidence now shows an explicit evidence progress percentage and five-row checklist. The checklist is display-only, validates false READY states, and cannot create order or scale-up permission.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Strategy evidence progress UX",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_DASHBOARD_SHELL:Strategy evidence progress visible and live-blocked",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Show strategy evidence progress and block false readiness",
            ...
            "depends_on": [
                ...
                "REQ-MVP4-UI-COMPLETION-RECHECK-OPERATOR-FLOW-HARDENING",
            ],
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_STRATEGY_EVIDENCE_PROGRESS_UX_HARDENING",
            ...
            "expanded_section_ids": [
                ...
                "AGENTS:dashboard-strategy-evidence-guide",
            ],
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_STRATEGY_EVIDENCE_PROGRESS_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Strategy Evidence Progress UX Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_STRATEGY_EVIDENCE_PROGRESS_UX_HARDENING"
