...
PATCH_BASENAME = "MVP4_RISK_EXPOSURE_QUALITY_GAP_RECHECK"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-RISK-EXPOSURE-QUALITY-GAP-RECHECK"
NEXT_TASK_CLASS = "MVP4_LEDGER_RECONCILIATION_IDEMPOTENCY_RECHECK"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_risk_exposure_quality_gap_recheck_patch_evidence.py",
    "contracts/generated/context_pack/RISK_EXPOSURE_QUALITY_GAP_RECHECK.md",
    "system/evidence/audit_reports/MVP4_RISK_EXPOSURE_QUALITY_GAP_RECHECK_20260429.md",
...
def update_navigation(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    ensure_requirement(
        index,
        {
            ...
            "source_section_id": "SECTION_RISK_SIZING_EXPOSURE",
            "source_file": "TRADER_1.md",
            "source_heading": "risk exposure quality gap recheck",
            "full_text_marker": f"{REQUIREMENT_ID}:missing paper exposure quality report cannot render low risk",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Missing paper exposure quality evidence cannot render LOW_RISK",
            "requirement_kind": "DASHBOARD_UX_VALIDATOR_PATCH",
            "schema_ids": ["trader1.read_only_dashboard_shell.v1"],
            "validator_ids": ["read_only_dashboard_validator", "live_final_guard_validator"],
            ...
            "depends_on": [
                "REQ-MVP4-RISK-EXPOSURE-FALSE-SAFE-RECHECK",
                "REQ-MVP4-PAPER-EXPOSURE-QUALITY-REPORT",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(b"missing paper exposure quality report cannot render low risk"),
    ...
    ensure_matrix_row(
        ...
        {
            "requirement_id": REQUIREMENT_ID,
            "section_id": "SECTION_RISK_SIZING_EXPOSURE",
    ...
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "RISK_EXPOSURE_QUALITY_GAP_RECHECK.md",
        f"""# RISK_EXPOSURE_QUALITY_GAP_RECHECK
...
Risk Exposure no longer shows LOW_RISK when the scoped paper exposure quality report is missing. It shows ATTENTION/yellow and tells the operator to generate paper_exposure_quality_report first.
    ...
    patch_result.update(
        {
            ...
            "next_optional_section_ids": ["SECTION_DASHBOARD_OPERATOR_UX", "SECTION_RACE_CONDITION_PARTIAL_WRITE"],
            ...
            "optimizer_patch": "NO_OPTIMIZER_RUNTIME_CHANGE_RISK_EXPOSURE_QUALITY_GAP_RECHECK",
            "optimizer_status_before": "RISK_EXPOSURE_LOW_RISK_WITH_MISSING_QUALITY_REPORT",
            "optimizer_status_after": "RISK_EXPOSURE_ATTENTION_UNTIL_QUALITY_REPORT_EXISTS",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_RISK_EXPOSURE_QUALITY_GAP_RECHECK_NO_LIVE_ORDERS",
    ...
    write_text(
        ...
        f"""# MVP4 Risk Exposure Quality Gap Recheck
