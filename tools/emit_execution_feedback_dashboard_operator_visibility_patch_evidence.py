...
PATCH_BASENAME = "MVP4_EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-EXECUTION-FEEDBACK-DASHBOARD-OPERATOR-VISIBILITY"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_execution_feedback_dashboard_operator_visibility_patch_evidence.py",
    "contracts/generated/context_pack/EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY.md",
    "system/evidence/audit_reports/MVP4_EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY_20260429.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY.md",
        f"""# EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY
...
Read-only dashboards now include an Execution Feedback panel. The panel shows execution quality, risk review, exposure review, drawdown review, net EV drift, cost drift, and optimizer ranking action for PAPER/SHADOW analysis only. Blocked feedback is rendered without ALLOW_RANKING so the operator cannot mistake rejected feedback for permission to rank or trade.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Execution feedback dashboard operator visibility",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_DASHBOARD_SHELL:Execution feedback visible as analysis-only",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Show execution feedback and paper-ranking review state without live permission",
            ...
            "live_affecting": True,
            "read_when": ["DASHBOARD_UX", "OPTIMIZER_MVP3", "PROFIT_CONVERGENCE_MVP3"],
            "depends_on": [
                "REQ-MVP1-READ-ONLY-DASHBOARD-SHELL",
                "REQ-MVP4-EXECUTION-FEEDBACK-COST-MODEL-HARDENING",
                "REQ-MVP4-EXECUTION-FEEDBACK-RISK-REVIEW-GAP-HARDENING",
            ],
    ...
    rows.append(
        {
            ...
            "fixture_files": ["tests/validators/fixtures/optimizer_feedback_pass.json"],
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_LONG_RUN_OPERATOR_SUMMARY_HARDENING",
            "next_required_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_RUNTIME_STABILITY", "SECTION_LONG_RUN_STABILITY"],
            "next_optional_section_ids": ["SECTION_CONVERGENCE_DASHBOARD", "SECTION_OPTIMIZER_DASHBOARD"],
            ...
            "active_read_surface_used": ["SECTION_DASHBOARD_SHELL", "SECTION_EXECUTION_FEEDBACK", "SECTION_OPTIMIZER_GUARDRAIL", "SECTION_LIVE_FINAL_GUARD"],
            "task_class": "MVP4_EXECUTION_FEEDBACK_DASHBOARD_OPERATOR_VISIBILITY",
            "required_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_EXECUTION_FEEDBACK", "SECTION_OPTIMIZER_GUARDRAIL", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": [
                ...
                "AGENTS:dashboard-operator-visibility-guide",
            ],
            ...
            "optimizer_patch": "OPTIMIZER_FEEDBACK_DASHBOARD_VISIBILITY",
            "optimizer_status_before": "PAPER_RANKING_FEEDBACK_VALIDATED_BUT_NOT_OPERATOR_VISIBLE",
            "optimizer_status_after": "PAPER_RANKING_FEEDBACK_OPERATOR_VISIBLE_ANALYSIS_ONLY",
            "optimizer_output_type": "DISPLAY_ONLY_PAPER_RANKING_FEEDBACK_PANEL",
            ...
            "profit_convergence_patch": "CONVERGENCE_DASHBOARD_DEPENDENCY_RECHECK",
            "convergence_layer_changed": False,
            "failure_analysis_required": False,
            "failure_analysis_status": "NOT_REQUIRED_FOR_DASHBOARD_OPERATOR_VISIBILITY",
            "convergence_validators_required": ["convergence_assessment_validator"],
            "convergence_validators_run": convergence_validators,
            "convergence_guardrail_result": "PASS_DASHBOARD_REMAINS_DISPLAY_ONLY",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_EXECUTION_FEEDBACK_DASHBOARD_VISIBILITY_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Execution Feedback Dashboard Operator Visibility Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_LONG_RUN_OPERATOR_SUMMARY_HARDENING"
