...
PATCH_BASENAME = "MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-SHADOW-HARNESS-MEASUREMENT-SOURCE-GUARD"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_shadow_harness_measurement_source_guard_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD.md",
]
BLOCKERS = [
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD.md",
        f"""# MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD
...
SHADOW actual runtime harness evidence now requires a verified local monotonic timer measurement source. Caller-supplied or unverified runtime values remain BLOCKED so the dashboard and patch evidence cannot imply a real execution window from an unchecked number.
    ...
    requirements.append(
        {
            ...
            "source_heading": "PAPER/SHADOW actual runtime harness measurement integrity",
            "full_text_marker": f"{REQUIREMENT_ID}:shadow actual runtime harness must block unverified runtime measurement source",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "SHADOW actual runtime harness measurement source guard",
            ...
            "live_affecting": True,
            "read_when": ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_RUNTIME_RECOVERY_RTO_ACTIVE", "SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            "depends_on": [
                "REQ-MVP4-SHADOW-OBSERVATION-ACTUAL-RUNTIME-HARNESS",
                "REQ-MVP4-SHADOW-HARNESS-EXECUTION-SUMMARY-RECHECK",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(b"shadow actual runtime harness must block unverified runtime measurement source"),
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_SHADOW_HARNESS_NEGATIVE_RUNTIME_MEASUREMENT_GUARD.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_registry_items": [REQUIREMENT_ID, "contracts/generated/context_pack/MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD.md"],
            ...
            "active_read_surface_used": [
                ...
                "shadow actual runtime harness measurement source slice",
                "dashboard shadow harness binding slice",
                "safe launcher dashboard artifact slice",
            ...
            "optimizer_stage": "NOT_CHANGED_SHADOW_RUNTIME_MEASUREMENT_SOURCE_GUARD_ONLY",
            ...
            "optimizer_validators_required": ["live_final_guard_validator", "read_only_dashboard_validator"],
            "optimizer_validators_run": ["live_final_guard_validator:PASS", "read_only_dashboard_validator:PASS"],
            "optimizer_guardrail_result": "PASS_NO_OPTIMIZER_LIVE_MUTATION",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "false",
            "convergence_layer_changed": False,
            "convergence_state_before": "SHORT_WINDOW_SHADOW_HARNESS_COULD_ACCEPT_NUMERIC_RUNTIME_WITHOUT_MEASUREMENT_SOURCE_PROOF",
            "convergence_state_after": "SHORT_WINDOW_SHADOW_HARNESS_BLOCKS_UNVERIFIED_RUNTIME_MEASUREMENT_SOURCE",
            ...
            "convergence_guardrail_result": "PASS_UNVERIFIED_RUNTIME_MEASUREMENT_SOURCE_FAILS_CLOSED_LIVE_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 SHADOW Harness Measurement Source Guard Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(
        set(state.get("implemented_schema_ids", []) + ["trader1.shadow_observation_actual_runtime_harness_report.v1"])
    )
