...
PATCH_ID = "MVP0_ORDER_PATH_GUARD_20260428_001"
...
def update_validator_registry(now: str) -> None:
    ...
    for validator_id in ["single_writer_order_path_validator", "strategy_direct_order_validator"]:
    ...
    registry["live_order_gateway_module"] = "trader1.execution.live_order_gateway"
...
def update_navigation(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    ensure_section(
        section_map,
        {
            "section_id": "SECTION_ORDER_PATH",
            "source_file": "TRADER_1.md",
            "source_sha256": trader_hash,
            "source_heading": "order path",
            "line_start": 9697,
            "line_end": 9726,
            "source_section_sha256": source_hash(trader_lines, 9697, 9726),
    ...
    ensure_section(
        section_map,
        {
            ...
            "line_start": 3711,
            "line_end": 3747,
            "source_section_sha256": source_hash(trader_lines, 3711, 3747),
            "authority_level": "ACTIVE_AUTHORITY",
            "read_default": False,
            "generated_artifact_is_authority": False,
        },
    ...
    requirement = {
        "requirement_id": "REQ-MVP0-ORDER-PATH-GUARD",
        "source_section_id": "SECTION_ORDER_PATH",
        "source_file": "TRADER_1.md",
        "source_heading": "order path",
        "full_text_marker": "strategy signals cannot place orders and live order path must be single-writer idempotent and blocked before adapter submit",
        "authority_level": "ACTIVE_AUTHORITY",
        "requirement_title": "MVP-0 fail-closed live order path guard",
        "requirement_kind": "MVP0_CONTRACT_BASELINE",
        "schema_ids": ["trader1.validator_result.v1"],
        "validator_ids": ["single_writer_order_path_validator", "strategy_direct_order_validator"],
        "artifact_ids": [
        ...
        "depends_on": ["REQ-MVP0-LIVE-BLOCKED-MATRIX", "REQ-MVP0-NAMESPACE-TRUTH"],
        "source_text_sha256": source_hash(trader_lines, 9697, 9726),
    ...
    ensure_matrix_row(
        matrix,
        {
            ...
            "evidence_artifacts": [
                "system/evidence/validator_runs/MVP0_ORDER_PATH_GUARD.validator_run_log.json",
                "system/evidence/patch_results/MVP0_ORDER_PATH_GUARD.patch_result.json",
            ],
            "dashboard_artifacts": [],
            "patch_result_fields": [
                "validators_run",
    ...
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "ORDER_PATH_GUARD.md",
        f"""# ORDER_PATH_GUARD
...
def update_state_and_evidence(now: str, trader_hash: str, agents_hash: str) -> None:
    validator_results = run_validators(["single_writer_order_path_validator", "strategy_direct_order_validator"])
    validator_log = {
    ...
    write_json(ROOT / "system" / "evidence" / "validator_runs" / "MVP0_ORDER_PATH_GUARD.validator_run_log.json", validator_log)
    ...
    stage_gate = {
        ...
        "single_writer_order_path": "PASS",
        "strategy_direct_order": "PASS",
        "live_order_allowed": False,
        "stage_gate_status": "PASS_FOR_MVP0_ORDER_PATH_GUARD_ONLY",
    }
    write_json(ROOT / "system" / "evidence" / "stage_gates" / "MVP0_ORDER_PATH_GUARD.stage_gate_result.json", stage_gate)
    ...
    evidence_manifest = {
        ...
        "evidence_manifest_id": "MVP0_ORDER_PATH_GUARD_EVIDENCE",
        "artifact_paths": [
            "trader1/execution/live_order_gateway.py",
            "tests/live_blocked/test_order_path_guard.py",
            "system/evidence/validator_runs/MVP0_ORDER_PATH_GUARD.validator_run_log.json",
            "system/evidence/stage_gates/MVP0_ORDER_PATH_GUARD.stage_gate_result.json",
        ],
        "known_blockers": [
            "LIVE_READY_MISSING",
    ...
    write_json(ROOT / "system" / "evidence" / "MVP0_ORDER_PATH_GUARD.evidence_manifest.json", evidence_manifest)
    ...
    patch_result = {
        ...
        "affected_contract_ids": ["REQ-MVP0-ORDER-PATH-GUARD"],
        ...
        "new_registry_items": ["single_writer_order_path_validator", "strategy_direct_order_validator"],
        "new_or_changed_schema_ids": [],
        "validators_required": ["single_writer_order_path_validator", "strategy_direct_order_validator"],
        "validators_run": validator_results,
        "tests_run": [
            {"command": "python tools/run_order_path_validators.py", "status": "PASS"},
            {"command": "python -m unittest tests.live_blocked.test_order_path_guard -v", "status": "PASS"},
            {"command": "python -m unittest discover -s tests -v", "status": "PASS"},
        ],
        "coverage_unmapped_count": 0,
        "registry_yaml_parse_status": "PASS",
        "registry_placeholders_remaining": [],
        "retained_archive_semantic_mapping_status": "RETAINED_ARCHIVE_READ_FOR_SECTION_LOCATOR_ONLY_NOT_EXECUTION_AUTHORITY",
        ...
        "evidence_manifest_path": "system/evidence/MVP0_ORDER_PATH_GUARD.evidence_manifest.json",
        "validator_run_log_path": "system/evidence/validator_runs/MVP0_ORDER_PATH_GUARD.validator_run_log.json",
        "stage_gate_result_path": "system/evidence/stage_gates/MVP0_ORDER_PATH_GUARD.stage_gate_result.json",
        "token_navigation_patch": True,
        "active_read_surface_used": ["SECTION_ORDER_PATH", "SECTION_LIVE_GATE", "SECTION_PATCH_RESULT"],
        "task_class": "MVP0_CONTRACT_BASELINE",
        "required_section_ids": ["SECTION_ORDER_PATH", "SECTION_LIVE_GATE", "SECTION_PATCH_RESULT"],
        "expanded_section_ids": [
            "SECTION_ORDER_PATH",
            "SECTION_LIVE_GATE",
            "SECTION_PATCH_RESULT",
            "AGENTS_DECISION_AND_ORDER_PATH",
            "RETAINED_ARCHIVE_ORDER_PATH_LOOKUP",
        ],
        ...
        "failure_analysis_status": "NOT_REQUIRED_FOR_ORDER_PATH_GUARD",
    ...
    write_json(ROOT / "system" / "evidence" / "patch_results" / "MVP0_ORDER_PATH_GUARD.patch_result.json", patch_result)

    state_path = ROOT / "contracts" / "generated" / "current_implementation_state.json"
    state = load_json(state_path)
    if "REQ-MVP0-ORDER-PATH-GUARD" not in state["completed_requirement_ids"]:
        state["completed_requirement_ids"].append("REQ-MVP0-ORDER-PATH-GUARD")
    for validator_id in ["single_writer_order_path_validator", "strategy_direct_order_validator"]:
    ...
    ledger["patches"].append(
        {
            ...
            "patch_class": "RUNTIME_SAFETY_PATCH",
            "target_mvp_level": "MVP-0",
            "patch_result_path": "system/evidence/patch_results/MVP0_ORDER_PATH_GUARD.patch_result.json",
