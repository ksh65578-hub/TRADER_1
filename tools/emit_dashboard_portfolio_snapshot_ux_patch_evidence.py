...
PATCH_BASENAME = "MVP4_DASHBOARD_PORTFOLIO_SNAPSHOT_UX"
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "DASHBOARD_PORTFOLIO_SNAPSHOT_UX.md",
        f"""# DASHBOARD_PORTFOLIO_SNAPSHOT_UX
...
The read-only dashboard now shows an operator-facing portfolio snapshot with Cash, Equity, Open Positions, and Return cards. Because no verified paper portfolio ledger or read-only account snapshot is active, all portfolio values show UNVERIFIED and remain dashboard display truth only.
""",
    )
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]], artifacts: list[str]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_CONSOLE_MONITOR_FRESH_HEARTBEAT.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "retained_archive_semantic_mapping_status": "UNCHANGED_NOT_REQUIRED_FOR_DASHBOARD_PORTFOLIO_SNAPSHOT_UX",
            ...
            "active_read_surface_used": ["SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD", "SECTION_MVP1_SUMMARY_SHELL"],
            "task_class": "MVP4_DASHBOARD_PORTFOLIO_SNAPSHOT_UX",
            "required_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD"],
            "expanded_section_ids": ["SECTION_DASHBOARD_SHELL", "SECTION_LIVE_FINAL_GUARD", "SECTION_MVP1_SUMMARY_SHELL"],
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_DASHBOARD_PORTFOLIO_SNAPSHOT_UX",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_DASHBOARD_PORTFOLIO_SNAPSHOT_UX_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_json(
        ROOT / patch_result["evidence_manifest_path"],
        {
            ...
            "artifact_paths": [
                ...
                "tools/emit_dashboard_portfolio_snapshot_ux_patch_evidence.py",
                "contracts/generated/context_pack/DASHBOARD_PORTFOLIO_SNAPSHOT_UX.md",
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Portfolio Snapshot UX Audit
