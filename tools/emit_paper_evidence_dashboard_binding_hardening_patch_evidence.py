...
PATCH_BASENAME = "MVP4_PAPER_EVIDENCE_DASHBOARD_BINDING_HARDENING"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-PAPER-EVIDENCE-DASHBOARD-BINDING-HARDENING"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_paper_evidence_dashboard_binding_hardening_patch_evidence.py",
    "contracts/generated/context_pack/PAPER_EVIDENCE_DASHBOARD_BINDING.md",
    "system/runtime/upbit/krw_spot/paper/mvp1_upbit_paper_launcher/paper_operation_gate_report.json",
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "PAPER_EVIDENCE_DASHBOARD_BINDING.md",
        f"""# PAPER_EVIDENCE_DASHBOARD_BINDING
...
## Current Safe State
        ...
        UPBIT PAPER launcher dashboard now reads exact-session paper operation gate evidence when present. Cross-session evidence is ignored to preserve namespace separation, and evidence binding cannot create order or scale-up permission.
""",
    )
    ...
    requirements.append(
        {
            ...
            "source_heading": "Paper evidence dashboard binding",
            "full_text_marker": f"{REQUIREMENT_ID}:SECTION_DASHBOARD_SHELL:Scoped paper evidence binds to dashboard progress",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Bind exact-session PAPER evidence to dashboard progress without namespace mixing",
            ...
            "depends_on": [
                ...
                "REQ-MVP3-OPERATIONAL-UPBIT-PAPER",
            ],
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_PAPER_EVIDENCE_DASHBOARD_BINDING_HARDENING",
            ...
            "expanded_section_ids": [
                ...
                "TRADER_1:paper-evidence-active-surface",
                "AGENTS:runtime-paper-evidence-dashboard-binding",
            ],
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_DISPLAY_ONLY_EVIDENCE_PROGRESS",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_PAPER_EVIDENCE_DASHBOARD_BINDING_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Paper Evidence Dashboard Binding Hardening Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_PAPER_EVIDENCE_DASHBOARD_BINDING_HARDENING"
