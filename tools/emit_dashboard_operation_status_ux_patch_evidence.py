...
PATCH_BASENAME = "MVP4_DASHBOARD_OPERATION_STATUS_UX"
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "DASHBOARD_OPERATION_STATUS_UX.md",
        f"""# DASHBOARD_OPERATION_STATUS_UX
...
Dashboard first screen now separates program health from trading permission. Fresh heartbeat shows normal SAFE_MODE monitoring with green/blue styling, while stale or missing sources show yellow warnings. Red styling is reserved for error severity.
""",
    )
    ...
    patch_result.update(
        {
            ...
            "next_task_class": "MVP4_DASHBOARD_POSITION_REASON_UX",
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_DASHBOARD_OPERATION_STATUS_UX",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_DASHBOARD_OPERATION_STATUS_UX_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_json(
        ROOT / patch_result["evidence_manifest_path"],
        {
            ...
            "artifact_paths": [
                ...
                "tools/emit_dashboard_operation_status_ux_patch_evidence.py",
                "contracts/generated/context_pack/DASHBOARD_OPERATION_STATUS_UX.md",
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Operation Status UX Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_DASHBOARD_POSITION_REASON_UX"
