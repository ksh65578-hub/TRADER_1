...
PATCH_BASENAME = "MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-SHADOW-RUNTIME-ORCHESTRATION-GUARD"
...
CHANGED_ARTIFACTS = [
    ...
    "trader1/research/shadow/shadow_observation_actual_runtime_harness.py",
    "contracts/schema/shadow_observation_runtime_orchestration_report.schema.json",
    "contracts/validators/validator_registry.json",
    "tests/research/test_shadow_observation_runtime_orchestration.py",
    "trader1/validation/mvp0_validators.py",
    "tools/emit_shadow_runtime_orchestration_guard_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD.md",
        f"""# MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD

context_pack_id: MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD
task_class: MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD
source_trader1_sha256: {trader_hash}
source_agents_sha256: {agents_hash}
included_section_ids: ["SECTION_PAPER_SHADOW_EVIDENCE", "SECTION_RUNTIME_RECOVERY_RTO_ACTIVE", "SECTION_LIVE_FINAL_GUARD", "SECTION_DASHBOARD_SHELL"]
included_requirement_ids: ["{REQUIREMENT_ID}"]
included_schema_ids: ["trader1.shadow_observation_runtime_orchestration_report.v1"]
included_validator_ids: {json.dumps(VALIDATORS_REQUIRED)}
included_artifact_ids: {json.dumps(CHANGED_ARTIFACTS)}
source_section_hashes: see contracts/generated/authority_section_map.json

acceptance_checklist:
- Persistent runtime stub and short-window actual runtime harness are bound by exact source hashes.
- The orchestration report blocks long-run evidence, scorecard input, promotion, optimizer ranking, live order readiness, live orders, and scale-up.
- Source hash, source pairing, false long-run, false scorecard, optimizer ranking, live order, and scale-up drift have negative tests.
- Operator wording keeps the result visible as not long-run evidence and live orders remain blocked.
...
SHADOW runtime orchestration now binds the persistent runtime stub to the short-window harness by exact source hash and explicitly reports that the combined output is not long-run evidence. Optimizer ranking, scorecard input, promotion, live orders, and scale-up remain blocked.
    ...
    requirements.append(
        {
            ...
            "source_heading": "PAPER/SHADOW runtime orchestration evidence boundary",
            "full_text_marker": f"{REQUIREMENT_ID}:shadow runtime orchestration must not convert stub or short-window harness output into long-run evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "SHADOW runtime orchestration long-run evidence guard",
            "requirement_kind": "RUNTIME_SAFETY_TEST_PATCH",
            "schema_ids": ["trader1.shadow_observation_runtime_orchestration_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": [
                "tests/research/test_shadow_observation_runtime_orchestration.py",
                "tests/research/test_shadow_observation_actual_runtime_harness.py",
            ...
            "depends_on": [
                "REQ-MVP4-SHADOW-OBSERVATION-PERSISTENT-RUNTIME",
                "REQ-MVP4-SHADOW-OBSERVATION-ACTUAL-RUNTIME-HARNESS",
                "REQ-MVP4-SHADOW-HARNESS-MEASUREMENT-SOURCE-GUARD",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(
                b"shadow runtime orchestration must not convert stub or short-window harness output into long-run evidence"
            ),
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/shadow_observation_runtime_orchestration_report.schema.json"],
            "validator_files": [
                "trader1/research/shadow/shadow_observation_runtime_orchestration.py",
                "trader1/validation/mvp0_validators.py",
            ],
            ...
            "runtime_modules": [
                "trader1/research/shadow/shadow_observation_runtime_orchestration.py",
                "trader1/research/shadow/shadow_observation_actual_runtime_harness.py",
                "trader1/research/shadow/shadow_observation_persistent_runtime.py",
            ],
            "evidence_artifacts": [
                f"system/evidence/{PATCH_BASENAME}.evidence_manifest.json",
                f"system/evidence/patch_results/{PATCH_BASENAME}.patch_result.json",
            ],
            "dashboard_artifacts": ["contracts/generated/ACTIVE_WORKING_VIEW.md"],
            "patch_result_fields": [
                "validators_run",
                "tests_run",
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_SHADOW_HARNESS_MEASUREMENT_SOURCE_GUARD.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "affected_mode": "PAPER_TO_SHADOW_READ_ONLY_DISPLAY",
            ...
            "new_or_changed_schema_ids": ["trader1.shadow_observation_runtime_orchestration_report.v1"],
            ...
            "next_optional_section_ids": ["OPT_SLICE_EXECUTION_FEEDBACK", "CONV_SLICE_EXECUTION_CALIBRATION", "SECTION_BUNDLE_SECURITY"],
            ...
            "active_read_surface_used": [
                ...
                "shadow persistent runtime slice",
                "shadow actual runtime harness slice",
                "runtime orchestration evidence boundary slice",
            ...
            "optimizer_stage": "NOT_CHANGED_SHADOW_RUNTIME_ORCHESTRATION_BLOCKER_ONLY",
            ...
            "optimizer_validators_run": [
                "shadow_observation_runtime_orchestration_validator:PASS",
                "live_final_guard_validator:PASS",
                "read_only_dashboard_validator:PASS",
            ],
            "optimizer_guardrail_result": "PASS_ORCHESTRATION_BLOCKS_OPTIMIZER_RANKING_UNTIL_LONG_RUN_EVIDENCE",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "false",
            "convergence_layer_changed": False,
            "convergence_state_before": "PERSISTENT_RUNTIME_STUB_AND_SHORT_WINDOW_HARNESS_NOT_BOUND_BY_ORCHESTRATION_REPORT",
            "convergence_state_after": "PERSISTENT_RUNTIME_STUB_AND_SHORT_WINDOW_HARNESS_BOUND_BY_FAIL_CLOSED_ORCHESTRATION_REPORT",
            ...
            "convergence_validators_run": [
                "shadow_observation_runtime_orchestration_validator:PASS",
                "shadow_observation_actual_runtime_harness_validator:PASS",
                "shadow_observation_persistent_runtime_validator:PASS",
                "live_final_guard_validator:PASS",
            ],
            "convergence_guardrail_result": "PASS_ORCHESTRATION_NOT_LONG_RUN_EVIDENCE_LIVE_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_SHADOW_RUNTIME_ORCHESTRATION_GUARD_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 SHADOW Runtime Orchestration Guard Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["implemented_schema_ids"] = sorted(
        set(state.get("implemented_schema_ids", []) + ["trader1.shadow_observation_runtime_orchestration_report.v1"])
    )
    state["implemented_validator_ids"] = sorted(
        set(state.get("implemented_validator_ids", []) + ["shadow_observation_runtime_orchestration_validator"])
    )
    ...
    tests_run = [
        ...
        run_command(
            [
                ...
                "-m",
                "unittest",
                "tests.research.test_shadow_observation_runtime_orchestration",
