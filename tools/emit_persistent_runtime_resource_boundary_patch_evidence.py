...
PATCH_BASENAME = "MVP4_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-PERSISTENT-RUNTIME-RESOURCE-BOUNDARY"
...
CHANGED_ARTIFACTS = [
    ...
    "contracts/schema/shadow_observation_persistent_runtime_report.schema.json",
    "tests/research/test_shadow_observation_persistent_runtime.py",
    "tools/emit_persistent_runtime_resource_boundary_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY.md",
        f"""# MVP4_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY
...
Actual long-run PAPER/SHADOW evidence remains missing. Persistent SHADOW runtime stub output now has closed short-window resource bounds, so a large stub cycle count or long estimated duration cannot appear as a normal operational PASS.
    ...
    requirements.append(
        {
            ...
            "full_text_marker": f"{REQUIREMENT_ID}: persistent runtime stub resource and duration bounds cannot be expanded into false long-run evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Persistent runtime resource boundary",
            "requirement_kind": "RUNTIME_SAFETY_PATCH",
            "schema_ids": ["trader1.shadow_observation_persistent_runtime_report.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/research/test_shadow_observation_persistent_runtime.py"],
            "mvp_stage": "MVP-4",
            ...
            "depends_on": [
                "REQ-MVP4-ACTUAL-RUNTIME-HARNESS-THRESHOLD-FLOOR",
                "REQ-MVP4-ACTUAL-RUNTIME-SOURCE-VALIDATION-GUARD",
                "REQ-MVP4-LIVE-FINAL-GUARD",
            ],
            "source_text_sha256": sha256_bytes(
                b"persistent runtime stub resource and duration bounds cannot be expanded into false long-run evidence"
            ),
    ...
    rows.append(
        {
            ...
            "schema_files": ["contracts/schema/shadow_observation_persistent_runtime_report.schema.json"],
            "validator_files": ["trader1/research/shadow/shadow_observation_persistent_runtime.py"],
            "test_files": ["tests/research/test_shadow_observation_persistent_runtime.py"],
            "fixture_files": [],
            "runtime_modules": ["trader1/research/shadow/shadow_observation_persistent_runtime.py"],
            "evidence_artifacts": [
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_ACTUAL_RUNTIME_HARNESS_THRESHOLD_FLOOR.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_or_changed_schema_ids": ["trader1.shadow_observation_persistent_runtime_report.v1"],
            ...
            "optimizer_stage": "NOT_CHANGED_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY_ONLY",
            ...
            "optimizer_guardrail_result": "PASS_PERSISTENT_RUNTIME_STUB_RESOURCE_EXPANSION_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "convergence_state_before": "LONG_RUN_EVIDENCE_BLOCKED_HARNESS_THRESHOLD_FLOORS_ENFORCED",
            "convergence_state_after": "LONG_RUN_EVIDENCE_BLOCKED_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY_ENFORCED",
            "convergence_guardrail_result": "PASS_PERSISTENT_RUNTIME_STUB_RESOURCE_EXPANSION_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_PERSISTENT_RUNTIME_RESOURCE_BOUNDARY_LIVE_BLOCKED",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Persistent Runtime Resource Boundary Audit
