...
PATCH_BASENAME = "MVP4_STALE_HEARTBEAT_RECOVERY_GUIDANCE"
REQUIREMENT_ID = "REQ-MVP4-STALE-HEARTBEAT-RECOVERY-GUIDANCE"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/run_stale_heartbeat_recovery_guidance_validators.py",
    "tools/emit_stale_heartbeat_recovery_guidance_patch_evidence.py",
    "contracts/generated/context_pack/STALE_HEARTBEAT_RECOVERY_GUIDANCE.md",
]
...
def update_navigation(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    requirement = {
        ...
        "source_heading": "stale heartbeat recovery guidance and display truth",
        "full_text_marker": f"{REQUIREMENT_ID}:stale heartbeat cannot look like a running safe monitor",
        "authority_level": "ACTIVE_AUTHORITY",
        "requirement_title": "Stale heartbeat recovery guidance",
        "requirement_kind": "DASHBOARD_UX",
        "schema_ids": ["trader1.read_only_dashboard_shell.v1"],
        "validator_ids": ["heartbeat_validator", "read_only_dashboard_validator", "root_launcher_surface_validator"],
        "artifact_ids": [
            "system/runtime/<exchange>/<market_type>/<mode>/<session_id>/heartbeat.json",
            "system/runtime/<exchange>/<market_type>/<mode>/<session_id>/dashboard/index.html",
        ],
        "test_ids": [
            "tests/runtime/test_safe_launcher.py",
            "tests/dashboard/test_read_only_dashboard.py",
        ...
        "depends_on": ["REQ-MVP1-HEARTBEAT", "REQ-MVP1-READ-ONLY-DASHBOARD-SHELL", "REQ-MVP4-CONSOLE-HEARTBEAT-VISIBILITY"],
        "source_text_sha256": sha256_bytes(b"stale heartbeat cannot look like a running safe monitor"),
    ...
    ensure_matrix_row(
        matrix,
        {
            ...
            "fixture_files": ["tests/runtime/test_safe_launcher.py"],
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "STALE_HEARTBEAT_RECOVERY_GUIDANCE.md",
        f"""# STALE_HEARTBEAT_RECOVERY_GUIDANCE
...
Dashboard and console heartbeat now distinguish fresh safe monitoring from stale heartbeat recovery states. Stale heartbeat display is yellow/blocked and tells the operator to rerun PAPER before trusting dashboard values.
""",
    )


def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_LONG_RUN_STABILITY_RESOURCE_GUARD.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "affected_contract_ids": [
                ...
                "REQ-MVP4-CONSOLE-HEARTBEAT-VISIBILITY",
            ],
            ...
            "next_task_class": "MVP4_SCHEMA_RUNTIME_INSTANCE_VALIDATION",
            "next_required_section_ids": ["SECTION_SCHEMA_VALIDATION", "SECTION_DASHBOARD_SERVING_TRUTH", "SECTION_LIVE_FINAL_GUARD"],
            ...
            "failure_analysis_status": "NOT_REQUIRED_FOR_STALE_HEARTBEAT_RECOVERY_GUIDANCE",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_STALE_HEARTBEAT_RECOVERY_GUIDANCE_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Stale Heartbeat Recovery Guidance Audit
...
def update_state_and_ledger(now: str, patch_result: dict[str, Any]) -> None:
    ...
    state["next_allowed_task_class"] = "MVP4_SCHEMA_RUNTIME_INSTANCE_VALIDATION"
...
def main() -> int:
    ...
    tests_run = [
        ...
        run_command([sys.executable, "-m", "unittest", "tests.dashboard.test_read_only_dashboard", "tests.runtime.test_safe_launcher", "-v"]),
        run_command([sys.executable, "tools/run_stale_heartbeat_recovery_guidance_validators.py"]),
