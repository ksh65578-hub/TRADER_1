...
PATCH_BASENAME = "MVP4_RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK"
PATCH_ID = f"{PATCH_BASENAME}_20260429_001"
REQUIREMENT_ID = "REQ-MVP4-RUNTIME-WRITE-LOCK-LIVE-OWNER-RECHECK"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_runtime_write_lock_live_owner_recheck_patch_evidence.py",
    "contracts/generated/context_pack/RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK.md",
    "system/evidence/audit_reports/MVP4_RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK_20260429.md",
]
BLOCKERS = [
    "LIVE_READY_MISSING",
    "API_UNVERIFIED",
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK.md",
        f"""# RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK
...
Runtime artifact writes are guarded by a same-session writer lock. The lock now checks whether a stale-looking owner process is still alive before removing the lock, preventing duplicate writer races during long-running safe monitor refreshes.
...
def update_requirement_artifacts(now: str, trader_hash: str, agents_hash: str) -> None:
    ...
    requirements.append(
        {
            ...
            "source_section_id": "SECTION_RUNTIME_WRITE_LOCK",
            "source_file": "TRADER_1.md",
            "source_heading": "Runtime write lock live-owner stale lock recheck",
            "full_text_marker": f"{REQUIREMENT_ID}:stale runtime locks must not be broken while owner process is alive",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Runtime write lock live-owner stale lock guard",
            "requirement_kind": "RUNTIME_SAFETY_TEST_PATCH",
            "schema_ids": ["trader1.root_launcher_report.v1", "trader1.patch_result.v1", "trader1.validator_result.v1"],
            ...
            "live_affecting": True,
            "read_when": ["SECTION_RUNTIME_WRITE_LOCK", "SECTION_RACE_CONDITION_PARTIAL_WRITE", "SECTION_LIVE_FINAL_GUARD"],
            "depends_on": ["REQ-MVP4-RUNTIME-WRITE-LOCK", "REQ-MVP4-PARTIAL-WRITE-CRASH-RECOVERY-RECHECK"],
            "source_text_sha256": sha256_bytes(b"stale runtime locks must not be broken while owner process is alive"),
    ...
    rows.append(
        {
            "requirement_id": REQUIREMENT_ID,
            "section_id": "SECTION_RUNTIME_WRITE_LOCK",
            "schema_files": [],
    ...
    patch_result.update(
        {
            ...
            "next_required_section_ids": [
                "SECTION_EVIDENCE_WRITE_HELPER_COVERAGE",
            ...
            "expanded_section_ids": [
                "TRADER_1:runtime-write-lock-active-surface",
                "TRADER_1:race-condition-partial-write-active-surface",
            ...
            "optimizer_patch": "NO_OPTIMIZER_RUNTIME_CHANGE_RUNTIME_LOCK_RECHECK",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_RUNTIME_WRITE_LOCK_LIVE_OWNER_RECHECK_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Runtime Write Lock Live Owner Recheck Audit
