...
PATCH_BASENAME = "MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY"
PATCH_ID = f"{PATCH_BASENAME}_20260430_001"
REQUIREMENT_ID = "REQ-MVP4-DASHBOARD-RUNTIME-ORCHESTRATION-VISIBILITY"
...
CHANGED_ARTIFACTS = [
    ...
    "tools/emit_dashboard_runtime_orchestration_visibility_patch_evidence.py",
    "contracts/generated/context_pack/MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY.md",
]
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY.md",
        f"""# MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY
...
The dashboard now shows a Runtime Orchestration Guard panel. It makes source pairing visible while clearly keeping long-run evidence, scorecard input, optimizer ranking, promotion, live orders, and scale-up blocked.
    ...
    requirements.append(
        {
            ...
            "source_heading": "Dashboard runtime orchestration visibility",
            "full_text_marker": f"{REQUIREMENT_ID}:dashboard must expose runtime orchestration source pairing without creating long-run or live evidence",
            "authority_level": "ACTIVE_AUTHORITY",
            "requirement_title": "Dashboard runtime orchestration visibility",
            "requirement_kind": "DASHBOARD_UX_RUNTIME_SAFETY_PATCH",
            "schema_ids": ["trader1.read_only_dashboard_shell.v1"],
            "validator_ids": VALIDATORS_REQUIRED,
            "artifact_ids": CHANGED_ARTIFACTS,
            "test_ids": ["tests/dashboard/test_read_only_dashboard.py", "tests/research/test_shadow_observation_runtime_orchestration.py"],
            "mvp_stage": "MVP-4",
            ...
            "source_text_sha256": sha256_bytes(
                b"dashboard must expose runtime orchestration source pairing without creating long-run or live evidence"
            ),
    ...
    rows.append(
        {
            ...
            "test_files": ["tests/dashboard/test_read_only_dashboard.py", "tests/research/test_shadow_observation_runtime_orchestration.py"],
            "fixture_files": [],
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_SHADOW_RUNTIME_ORCHESTRATION_GUARD.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "new_registry_items": [REQUIREMENT_ID, "contracts/generated/context_pack/MVP4_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY.md"],
            ...
            "active_read_surface_used": [
                ...
                "dashboard shell runtime evidence boundary slice",
                "shadow runtime orchestration guard slice",
            ...
            "optimizer_guardrail_result": "PASS_DASHBOARD_SHOWS_OPTIMIZER_RANKING_BLOCKED",
            "optimizer_live_mutation_detected": False,
            "optimizer_live_order_allowed_after": False,
            "profit_convergence_patch": "false",
            "convergence_layer_changed": False,
            "convergence_state_before": "RUNTIME_ORCHESTRATION_GUARD_NOT_VISIBLE_ON_DASHBOARD",
            "convergence_state_after": "RUNTIME_ORCHESTRATION_GUARD_VISIBLE_AS_DISPLAY_ONLY_BLOCKER",
            ...
            "convergence_guardrail_result": "PASS_DASHBOARD_ORCHESTRATION_VISIBILITY_LIVE_BLOCKED",
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_DASHBOARD_RUNTIME_ORCHESTRATION_VISIBILITY_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_text(
        ...
        f"""# MVP4 Dashboard Runtime Orchestration Visibility Audit
