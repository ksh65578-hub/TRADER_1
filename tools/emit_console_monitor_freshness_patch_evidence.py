...
PATCH_BASENAME = "MVP4_CONSOLE_MONITOR_FRESH_HEARTBEAT"
...
def update_context(now: str, trader_hash: str, agents_hash: str) -> None:
    write_text(
        ROOT / "contracts" / "generated" / "context_pack" / "CONSOLE_MONITOR_FRESH_HEARTBEAT.md",
        f"""# CONSOLE_MONITOR_FRESH_HEARTBEAT

context_pack_id: CONSOLE_MONITOR_FRESH_HEARTBEAT
task_class: MVP4_CONSOLE_MONITOR_FRESH_HEARTBEAT
...
included_schema_ids: ["trader1.patch_result.v1", "trader1.root_launcher_report.v1", "trader1.heartbeat.v1", "trader1.read_only_dashboard_shell.v1"]
included_validator_ids: {json.dumps(VALIDATORS_REQUIRED)}
included_artifact_ids: ["trader1/runtime/boot/safe_launcher.py", "tests/runtime/test_safe_launcher.py", "contracts/schema/patch_result.schema.json"]
source_section_hashes: see contracts/generated/authority_section_map.json

acceptance_checklist:
- interactive console monitor refreshes heartbeat/dashboard artifacts before each heartbeat line
- console heartbeat line includes heartbeat_at to expose freshness
- launcher artifact writes use temp-file replace to reduce partial-write risk
- patch_result schema and historical artifacts include merged_requirements, coverage_index_result, and scale_up_allowed_before
- live_order_ready=false, live_order_allowed=false, can_live_trade=false, scale_up_allowed=false

known_omissions_by_design:
- no runtime trading engine is introduced
- no live key loading
- no live order API
...
Interactive console monitoring refreshes heartbeat/dashboard artifacts before each printed heartbeat. The line includes heartbeat_at so a stale monitor cannot look alive without showing stale evidence. Launcher artifact writes use temp-file replacement.
""",
    )
...
def build_patch_result(now: str, tests_run: list[dict[str, Any]], validators_run: list[dict[str, Any]], artifacts: list[str]) -> dict[str, Any]:
    template = load_json(ROOT / "system" / "evidence" / "patch_results" / "MVP4_CONSOLE_SAFE_MONITOR_HEARTBEAT.patch_result.json")
    ...
    patch_result.update(
        {
            ...
            "retained_archive_semantic_mapping_status": "UNCHANGED_NOT_REQUIRED_FOR_CONSOLE_MONITOR_FRESHNESS_PATCH",
            ...
            "next_optional_section_ids": ["SECTION_MVP1_HEARTBEAT", "SECTION_ROOT_LAUNCHER"],
            ...
            "task_class": "MVP4_CONSOLE_MONITOR_FRESH_HEARTBEAT",
            "required_section_ids": ["SECTION_MVP1_ROOT_LAUNCHER_SCOPE", "SECTION_MVP1_HEARTBEAT", "SECTION_PATCH_RESULT_SCHEMA"],
            "expanded_section_ids": ["SECTION_MVP1_ROOT_LAUNCHER_SCOPE", "SECTION_MVP1_HEARTBEAT", "SECTION_MVP1_SAFE_BOOT_SEQUENCE"],
...
def write_evidence(now: str, trader_hash: str, agents_hash: str, patch_result: dict[str, Any]) -> None:
    ...
    write_json(
        ROOT / patch_result["stage_gate_result_path"],
        {
            ...
            "patch_id": PATCH_ID,
            "target_mvp_level": "MVP-4",
            "stage_gate_status": "PASS_FOR_CONSOLE_MONITOR_FRESH_HEARTBEAT_NO_LIVE_ORDERS",
            "live_order_ready": False,
            "live_order_allowed": False,
            "can_live_trade": False,
            "scale_up_allowed": False,
    ...
    write_json(
        ROOT / patch_result["evidence_manifest_path"],
        {
            ...
            "artifact_paths": [
                ...
                "tools/emit_console_monitor_freshness_patch_evidence.py",
                "contracts/generated/context_pack/CONSOLE_MONITOR_FRESH_HEARTBEAT.md",
    ...
    write_text(
        ...
        f"""# MVP4 Console Monitor Fresh Heartbeat Audit
...
def main() -> int:
    ...
    tests_run = [
        ...
        run_command([sys.executable, "-m", "unittest", "tests.runtime.test_heartbeat", "tests.dashboard.test_read_only_dashboard", "-v"]),
