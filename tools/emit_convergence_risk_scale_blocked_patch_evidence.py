...
PATCH_ID = "MVP4_CONVERGENCE_RISK_SCALE_BLOCKED_20260429_001"
PATCH_RESULT_REL = "system/evidence/patch_results/MVP4_CONVERGENCE_RISK_SCALE_BLOCKED.patch_result.json"
RISK_SCALE_IDS = [
...
def write_validator_log(
    ...
    path = ROOT / "system" / "evidence" / "validator_runs" / "MVP4_CONVERGENCE_RISK_SCALE_BLOCKED.validator_run_log.json"
    write_json(
        path,
        {
...
def write_stage_gate(now: str, validator_log_path: Path) -> Path:
    path = ROOT / "system" / "evidence" / "stage_gates" / "MVP4_CONVERGENCE_RISK_SCALE_BLOCKED.stage_gate_result.json"
    write_json(
        path,
        {
            ...
            "stage_gate_status": "RISK_SCALE_VALIDATORS_RUN_SCALE_UP_BLOCKED",
...
def write_evidence_manifest(now: str, authority: dict[str, str], validator_log_path: Path, stage_gate_path: Path) -> Path:
    path = ROOT / "system" / "evidence" / "MVP4_CONVERGENCE_RISK_SCALE_BLOCKED.evidence_manifest.json"
    write_json(
        path,
        {
            ...
            "project_id": "TRADER_1",
            "authority": authority,
            "evidence_manifest_id": "MVP4_CONVERGENCE_RISK_SCALE_BLOCKED_EVIDENCE",
            "artifact_paths": [
...
def build_patch_result(
    ...
    patch_result = {
        ...
        "affected_contract_ids": ["REQ-CONV-RISK-SCALING-VALIDATORS"],
        ...
        "new_registry_items": ["convergence risk scale validators marked IMPLEMENTED_FAIL_CLOSED"],
        "new_or_changed_schema_ids": [],
        "validators_required": RISK_SCALE_IDS + DEPENDENCY_UNTESTED_IDS + GUARDRAIL_IDS,
        "validators_run": risk_results + guardrail_results,
        "tests_run": test_results,
        "coverage_unmapped_count": 0,
        "registry_yaml_parse_status": "PASS",
        "registry_placeholders_remaining": [],
        "retained_archive_semantic_mapping_status": "NOT_READ_NOT_REQUIRED_FOR_CONVERGENCE_RISK_SCALE_PATCH",
        ...
        "expanded_section_ids": ["TRADER_1:1970-2008", "AGENTS:744-776"],
        ...
        "profit_convergence_patch": "FAIL_CLOSED_RISK_SCALE_VALIDATOR_PATCH",
        "convergence_layer_changed": False,
        "convergence_state_before": "ASSESSMENT_GUARDRAIL_PASS_LIVE_STILL_BLOCKED",
        "convergence_state_after": "RISK_SCALE_BLOCKED_LIVE_STILL_BLOCKED",
        "objective_profile_changed": False,
        "memory_schema_changed": False,
        "failure_analysis_required": False,
        "failure_analysis_status": "NOT_REQUIRED_FOR_CONVERGENCE_RISK_SCALE_PATCH",
