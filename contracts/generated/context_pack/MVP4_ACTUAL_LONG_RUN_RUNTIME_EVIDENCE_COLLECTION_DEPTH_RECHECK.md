...
included_artifact_ids: ["contracts/schema/upbit_paper_runtime_evidence_collection_profile_report.schema.json", "contracts/schema/read_only_dashboard_shell.schema.json", "tools/run_upbit_paper_runtime_evidence_collection_profile.py", "trader1/dashboard/read_only_dashboard.py", "tests/runtime/test_upbit_paper_runtime_evidence_collection_profile.py", "tests/dashboard/test_read_only_dashboard.py", "tests/contract/test_actual_long_run_runtime_evidence_collection_depth_recheck.py", "system/evidence/runtime_checks/MVP4_UPBIT_PAPER_RUNTIME_EVIDENCE_COLLECTION_PROFILE.report.json", "tools/emit_actual_long_run_runtime_evidence_collection_depth_recheck_patch_evidence.py", "contracts/generated/context_pack/MVP4_ACTUAL_LONG_RUN_RUNTIME_EVIDENCE_COLLECTION_DEPTH_RECHECK.md"]
...
generated_at_utc: 2026-05-04T06:07:12Z
